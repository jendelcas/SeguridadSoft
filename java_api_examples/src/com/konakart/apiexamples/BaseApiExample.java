...
public class BaseApiExample
{
    ...
    /** JSON Custom Store Service Engine */
    protected static final String KKJSONCustomStoreEngName = "com.konakart.json.KKJSONCustomStoreServiceEng";
    ...
    static protected void parseArgs(String[] args, String usage, int minArgs)
    {
        ...
        for (int a = 0; a < args.length; a++)
        {
            ...
            {
                System.out.println("Blank argument ignored");
            } else
            {
        ...
        if (isDebug())
        {
            ...
            System.out.println(
                    "Engine Mode:       " + KKCodeDescription.engineModeToString(getEngineMode()));
            ...
            IllegalArgumentException, InvocationTargetException
    {
         ...
         * KKRMIEng, KKJAXWSEng or KKJSONEng for the RMI, SOAP or JSON engines
         */
        ...
        PropertiesConfiguration allConfig = PropertiesUtils
                .getConfiguration(KKConstants.KONAKART_PROPERTIES_FILE);
    ...
    protected static int getProductIdByName(String name) throws KKException
    {
        ...
        for (int p = 0; p < prod.length; p++)
        {
            ...
            {
                System.out.println(
                        "Product with name '" + name + "' found - id = " + prod[p].getId());
                return prod[p].getId();
            }
        }
