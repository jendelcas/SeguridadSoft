...
public class AdminAppLauncher extends HttpServlet
{
            ...
            throws ServletException, IOException
    {
        ...
        String escapedStoreId = Utils.escapeHtml(storeId);
        ...
        try
        {
            ...
            Configuration conf = PropertiesUtils.getConfiguration(configFile);
            ...
            {
                writer.println(
                        "<input type=\"hidden\" name=\"store\" value=\"" + escapedStoreId + "\">");
            }
            writer.println("</form>");
            writer.println("</body>");
            writer.println("</html>");
    ...
    {
        // You can choose from these two implementations:
        ...
        if (option == 1)
        {
            // Option 1
            // --------
            // This commented out version allows you to open a named class. It's more flexible but
            // is a little less secure:

            Class<?> theClass = Class.forName(className);
            AdminAppAuthenticationMgrIf authMgr = (AdminAppAuthenticationMgrIf) theClass
                    .newInstance();
            return authMgr;
        }
        ...
        if (option == 2)
        {
            // Option 2
            // --------
            // This hard-codes the instantiation of the AdminAppAuthenticationMgr. It's less
            // flexible but is a little more secure:

            return new AdminAppAuthenticationMgr();
        }

        // default if option isn't set to 1 or 2
        return new AdminAppAuthenticationMgr();
    }
}