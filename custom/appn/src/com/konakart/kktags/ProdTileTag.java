...
public class ProdTileTag extends BaseTag
{
     ...
     *            the sb
     * @throws JspException
     *             an unexpected JspException exception
    ...
    public void renderTag(StringBuffer sb) throws JspException, KKAppException
    {
        ...
        } else
        {
            ...
            {
                sb.append(getStartA("add-to-cart-button button small-rounded-corners", "#",
            ...
            // Shipping
            if (prod.getType() == com.konakart.bl.ProductMgr.FREE_SHIPPING || prod
                    .getType() == com.konakart.bl.ProductMgr.FREE_SHIPPING_BUNDLE_PRODUCT_TYPE)
            {
            ...
            if (eng.isMultiVendor() && eng.isMultiVendorStoreLinks() && prod.getStoreName() != null)
            {
                sb.append(getStartDiv("item-sold-by"));
                sb.append("<a href=\"StoreDetails.action?id=" + prod.getStoreId() + "\">");
                sb.append(getMsg("product.details.body.sold.by") + " <b>" + prod.getStoreName()
                        + "</b>");
                sb.append("</a>");
                sb.append(END_DIV);
            }
    ...
    private void getReviews(StringBuffer sb)
    {
        ...
        int rating = (prod.getRating() == null) ? 0
                : prod.getRating().setScale(0, java.math.BigDecimal.ROUND_HALF_UP).intValue();
    ...
    private BigDecimal getPrices(StringBuffer sb) throws KKAppException
    {
        ...
        if (prod.getWeightUOM() != null && prod.getWeightUOM().length() > 0
                && prod.getPrice2() != null)
        {
            sb.append(getStartSpan("price-uom"));
            sb.append("(" + eng.formatPrice(prod.getPrice2()) + "/" + prod.getWeightUOM() + ")");
            sb.append(END_SPAN);
        }
        sb.append(END_DIV);
        return saving;
