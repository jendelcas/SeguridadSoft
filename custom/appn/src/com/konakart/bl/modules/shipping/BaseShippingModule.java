...
public class BaseShippingModule extends BaseModule
{
     ...
     * 
     * @param info
     *            the ShippingInfo - this defines the items to be shipped
     * @param geoZoneId
     *            the geoZoneId
     * @throws KKException
    ...
    protected boolean isGeoZoneMappedToCountry(int geoZoneId, int countryId)
    {
        ...
        {
            log.error("Unexpected exception in isGeoZoneMappedToCountry method: "
     ...
     * 
     * @return true if multiStore and we're sharing customers
     * @throws KKException
     *             an unexpected exception from the KonaKart engine
     */
