...
public class KKAdminCustomEng implements com.konakartadmin.appif.KKAdminIf
{
     ...
     */
     ...
     private RemoveMallStore _removeMallStore = null;
     ...
     private UpdateCustomerWithOptions _updateCustomerWithOptions = null;
     ...
     private DeleteReviewsPerCustomer _deleteReviewsPerCustomer = null;
     private DeleteVendorReviewsPerCustomer _deleteVendorReviewsPerCustomer = null;
     private DeleteVendorReview _deleteVendorReview = null;
     ...
     private CopyFiles _copyFiles = null;
     private RenameFile _renameFile = null;
     private RenameFiles _renameFiles = null;
     ...
     private RemoveRelatedProduct _removeRelatedProduct = null;
     ...
     private DeleteCatalogWithOptions _deleteCatalogWithOptions = null;
     ...
     private InsertVendor _insertVendor = null;
     private UpdateVendor _updateVendor = null;
     private GetVendors _getVendors = null;
     private GetVendorForId _getVendorForId = null;
     private DeleteVendor _deleteVendor = null;
     private GetVendorReviews _getVendorReviews = null;
     private GetVendorReview _getVendorReview = null;
     private GetReviewsPerVendor _getReviewsPerVendor = null;
     private AddVendorToStore _addVendorToStore = null;
     private InsertCatalogPrices _insertCatalogPrices = null;
     private CloneCustomer _cloneCustomer = null;
     private DeleteCustomerMultiStore _deleteCustomerMultiStore = null;
     private GetStoresForCustomer _getStoresForCustomer = null;
     private GetSuggestions _getSuggestions = null;
     private InsertSuggestions _insertSuggestions = null;
     private DeleteSuggestions _deleteSuggestions = null;
     private GetOrderReturnStatuses _getOrderReturnStatuses = null;
     private DeleteOrderReturnStatus _deleteOrderReturnStatus = null;
     private InsertOrderReturnStatus _insertOrderReturnStatus = null;
     private InsertOrderReturnStatuses _insertOrderReturnStatuses = null;
     private UpdateOrderReturnStatus _updateOrderReturnStatus = null;
     private GetAllOrderReturnStatuses _getAllOrderReturnStatuses = null;
...
protected KKAdminException manageThrowable(Throwable e)
{
    ...
    /**
     * Removes a Store. (The store and all records that have this storeId are actually deleted from
     * the database). This API call is disabled by default in the konakartadmin.properties file.
     * <p>
     * Multi-Store Single DB only
     * 
     * @param sessionId
     ...
     */
     public void removeMallStore(String sessionId, String storeId) throws KKAdminException
     {
         try
         {
            if (_removeMallStore == null)
            {
                _removeMallStore = new RemoveMallStore(kkAdminEng);
            }

            _removeMallStore.removeMallStore(sessionId, storeId);
         } catch (Throwable e)
         {
            throw manageThrowable(e);
         }
    ...
    /**
     * Returns the property value from the properties file in the specified section. Note that if
     * the property contains a comma-separated set of values only the first value is returned. If
     * you want to use multiple values for a property use space-separated values. When
     * space-separated property values are used all of the values are returned by this call.
     * 
     * @param sessionId
     *            The session Id of the logged in user
     * @param section
     ...
     * @return Returns a currency object or null if there is no currency with the specified code
     * @throws KKAdminException
     *             an unexpected exception in the KonaKart Admin engine
     */
     ...
     * <li>store id</li>
     * <li>parent id</li>
     * <li>invoice filename</li>
     * <li>filters</li>
     * <li>admin discount</li>
     * <li>custom1</li>
     * <li>custom2</li>
     * <li>custom3</li>
     * <li>custom4</li>
     ...
     *            set is unique (does not belong to an existing registered customer).
     * @throws KKAdminException
     *             an unexpected exception in the KonaKart Admin engine
     */
     public void updateCustomerWithOptions(String sessionId, AdminCustomer customer, AdminUpdateCustomerOptions options) throws KKAdminException
     {
         try
         {
            if (_updateCustomerWithOptions == null)
            {
                _updateCustomerWithOptions = new UpdateCustomerWithOptions(kkAdminEng);
            }

            _updateCustomerWithOptions.updateCustomerWithOptions(sessionId, customer, options);
         } catch (Throwable e)
         {
            throw manageThrowable(e);
         }
     ...
     * eMail address, then an exception is thrown. The Customer Registration object also allows you
     * to set a uniqueness check on the telephone numbers.
     * 
     * @param sessionId
     *            The session Id of the logged in user
     * @param custReg
     ...
     *             registered customer already exists with the same eMail address
     */
     ...
     *             found, or problems resetting the password or sending the email.
     */
     ...
     *             doesn't match or the newPassword cannot be validated
     */
    ...
    /**
     * Change a user's password. This is used when a sessionId cannot be obtained for a user because
     ...
     *             in, current password doesn't match or the newPassword cannot be validated
     */
     ...
     *             catalogue that references a message that explains why.
     */
     ...
     * <li>AdminDataDescriptor.ORDER_BY_EXPIRY_DATE_ASCENDING</li>
     * <li>AdminDataDescriptor.ORDER_BY_EXPIRY_DATE_DESCENDING</li>
     ...
     */
     public void deleteReviewsPerCustomer(String sessionId, int customerId) throws KKAdminException
     {
         try
         {
            if (_deleteReviewsPerCustomer == null)
            {
                _deleteReviewsPerCustomer = new DeleteReviewsPerCustomer(kkAdminEng);
            }

            _deleteReviewsPerCustomer.deleteReviewsPerCustomer(sessionId, customerId);
         } catch (Throwable e)
         {
            throw manageThrowable(e);
         }
     ...
     */
     public void deleteVendorReviewsPerCustomer(String sessionId, int customerId) throws KKAdminException
     {
         try
         {
            if (_deleteVendorReviewsPerCustomer == null)
            {
                _deleteVendorReviewsPerCustomer = new DeleteVendorReviewsPerCustomer(kkAdminEng);
            }

            _deleteVendorReviewsPerCustomer.deleteVendorReviewsPerCustomer(sessionId, customerId);
         } catch (Throwable e)
         {
            throw manageThrowable(e);
         }
     ...
     */
     public void deleteVendorReview(String sessionId, int reviewId) throws KKAdminException
     {
         try
         {
            if (_deleteVendorReview == null)
            {
                _deleteVendorReview = new DeleteVendorReview(kkAdminEng);
            }

            _deleteVendorReview.deleteVendorReview(sessionId, reviewId);
         } catch (Throwable e)
         {
            throw manageThrowable(e);
         }
     ...
     * </li>
     * </ul>
     * The AdminDataDescriptor allows to add search constraints for the custom fields 1 to 3 and to
     * order the result set as follows:
     * <ul>
     * <li>AdminDataDescriptor.ORDER_BY_DATE_ADDED</li>
     * <li>AdminDataDescriptor.ORDER_BY_DATE_ADDED_DESCENDING</li>
     * <li>AdminDataDescriptor.ORDER_BY_DATE_ADDED_ASCENDING</li>
    ...
    /**
     * A new review is inserted. If the customerId on the review is 0 the name used for the review
     * will be the customerName passed in on the review. If the customerId on the review is not 0
     * the name used for the review will be calculated by looking up the customer with the specified
     * customerId then formatting the customer's name according to the definition of the
     * NAME_FORMAT_TEMPLATE. Therefore, if the customerId is not 0 it must be the Id of a customer
     ...
     *             can't be read, or it's not a text file
     */
     ...
     *             problems that prevent us from saving the data to the file.
     */
     ...
     *            The session Id of the logged in user
     * @param srcFileNames
     *            an array of filenames in the server's context to copy from
     * @param dstFileNames
     *            an array of filenames in the server's context to copy to
     * @throws KKAdminException
     *             an unexpected exception in the KonaKart Admin engine if any of the source file
     *             are not present or can't be copied
     * @return true if the file was copied successfully, otherwise an exception is thrown.
     */
     public boolean copyFiles(String sessionId, String[] srcFileNames, String[] dstFileNames) throws KKAdminException
     {
         try
         {
            if (_copyFiles == null)
            {
                _copyFiles = new CopyFiles(kkAdminEng);
            }

            return _copyFiles.copyFiles(sessionId, srcFileNames, dstFileNames);
         } catch (Throwable e)
         {
            throw manageThrowable(e);
         }
     ...
     *            The session Id of the logged in user
     * @param srcFileName
     *            the filename in the server's context to rename from
     * @param dstFileName
     *            the filename in the server's context to rename to
     * @throws KKAdminException
     *             an unexpected exception in the KonaKart Admin engine if the source file's not
     *             present or can't be renamed
     * @return true if the file was renamed successfully, otherwise an exception is thrown.
     */
     public boolean renameFile(String sessionId, String srcFileName, String dstFileName) throws KKAdminException
     {
         try
         {
            if (_renameFile == null)
            {
                _renameFile = new RenameFile(kkAdminEng);
            }

            return _renameFile.renameFile(sessionId, srcFileName, dstFileName);
         } catch (Throwable e)
         {
            throw manageThrowable(e);
         }
     ...
     *            The session Id of the logged in user
     * @param srcFileNames
     *            an array of filenames in the server's context to rename from
     * @param dstFileNames
     *            an array of filenames in the server's context to rename to
     * @throws KKAdminException
     *             an unexpected exception in the KonaKart Admin engine if any of the source file
     *             are not present or can't be renamed
     * @return true if the file was copied successfully, otherwise an exception is thrown.
     */
     public boolean renameFiles(String sessionId, String[] srcFileNames, String[] dstFileNames) throws KKAdminException
     {
         try
         {
            if (_renameFiles == null)
            {
                _renameFiles = new RenameFiles(kkAdminEng);
            }

            return _renameFiles.renameFiles(sessionId, srcFileNames, dstFileNames);
         } catch (Throwable e)
         {
            throw manageThrowable(e);
         }
     ...
     * <ul>
     * <li>AdminPromotionMgr.EXCLUDE : The categories in the array are excluded from the
     * promotion</li>
     * <li>AdminPromotionMgr.INCLUDE : The categories in the array are included in the
     * promotion</li>
     * </ul>
     * 
     * @param sessionId
     ...
     * <ul>
     * <li>AdminPromotionMgr.EXCLUDE : The customers in the array are excluded from the
     * promotion</li>
     ...
     * promotion</li>
     * <li>AdminPromotionMgr.INCLUDE : The manufacturers in the array are included in the
     * promotion</li>
     * </ul>
     * 
     * @param sessionId
     ...
     * <ul>
     * <li>AdminPromotionMgr.EXCLUDE : The products in the array are excluded from the
     * promotion</li>
     ...
     * productId. If relationType == 0, then all existing relations on product with id == productId
     * are removed.
     * <p>
     * Valid values for relationType are:
     * <ul>
     ...
     *            The session id of the logged in user
     * @param productIdFrom
     *            the productId the relation generates from
     * @param productIdTo
     *            the productId the relation points to
     * @param relationType
     *            the relationType
     * @throws KKAdminException
     *             an unexpected exception in the KonaKart Admin engine
     */
     public void removeRelatedProduct(String sessionId, int productIdFrom, int productIdTo, int relationType) throws KKAdminException
     {
         try
         {
            if (_removeRelatedProduct == null)
            {
                _removeRelatedProduct = new RemoveRelatedProduct(kkAdminEng);
            }

            _removeRelatedProduct.removeRelatedProduct(sessionId, productIdFrom, productIdTo, relationType);
         } catch (Throwable e)
         {
            throw manageThrowable(e);
         }
     ...
     * <li>Specify a two letter country code to force the eMail template with that code to be
     * used.</li>
     ...
     * <li>Parent Id</li>
     * <li>Refund value and points of OrderProducts</li>
     * </ul>
     * <p>
     ...
     * product ids already exist, they will be updated with the new data. Multiple threads are used
     * to maximise performance.
     * <p>
     * There are configuration parameters in konakartadmin.properties that can be modified to
     * maximise performance based on the available resources.
     * <ul>
     * <li>konakart.solr.num.threads - Maximum number of executor threads working in parallel
     * sending products to Solr</li>
     * <li>konakart.solr.product.block.size - Number of products read from the relational database
     * in a single read operation and fed to each thread</li>
     * <li>konakart.solr.shutdown.wait.secs - Number of seconds to wait for executor threads to end
     * for a graceful shutdown</li>
     * </ul>
     * If com.konakartadmin logging is set to INFO, the log provides some useful information that
     * can be used to decide how many threads to use depending on whether the bottleneck is reading
     * the products from the relational database or sending them to Solr.
     * 
     * @param sessionId
     *            Session Id
     * @param async
     ...
     * to products indirectly using a separate DB table.</li>
     * </ul>
     * 
     * @param sessionId
     *            session Id of logged in Admin user
     ...
     *             record specified is invalid or there are database problems
     */
    ...
    /**
     * Returns an array of files found in the directory ordered by lastModified date descending. If
     * the extension is not null, then the files are filtered by extension.
     * 
     * @param sessionId
     *            The session id of the logged in user
     * @param directory
     ...
     * @return Returns an array of Admin File objects ordered by lastModified date descending
     * @throws KKAdminException
     *             an unexpected exception in the KonaKart Admin engine
     */
     ...
     *            The numeric id of the catalog
     * @param options
     *            define whether or not to remove prices for this catalog as well.
     * @throws KKAdminException
     *             an unexpected exception in the KonaKart Admin engine
     */
     public void deleteCatalogWithOptions(String sessionId, int catalogId, AdminDeleteCatalogOptions options) throws KKAdminException
     {
         try
         {
            if (_deleteCatalogWithOptions == null)
            {
                _deleteCatalogWithOptions = new DeleteCatalogWithOptions(kkAdminEng);
            }

            _deleteCatalogWithOptions.deleteCatalogWithOptions(sessionId, catalogId, options);
         } catch (Throwable e)
         {
            throw manageThrowable(e);
         }
     ...
     * <li>AdminDataDescriptor.ORDER_BY_NAME_ASCENDING</li>
     * <li>AdminDataDescriptor.ORDER_BY_NAME_DESCENDING</li>
     * <li>AdminDataDescriptor.ORDER_BY_DATE_ACTIVE_ASCENDING</li>
     * <li>AdminDataDescriptor.ORDER_BY_DATE_ACTIVE_DESCENDING</li>
     * </ul>
     * 
     * @param sessionId
     *            The session id of the logged in user
    ...
    /**
     * Delete an AdminMiscItem. The record with the specified miscellaneous item id will be
     * deleted.
     * 
     * @param sessionId
     *            The session id of the logged in user
     ...
     *             an unexpected exception in the KonaKart Admin engine
     */
     public void deleteMiscItem(String sessionId, int miId) throws KKAdminException
     {
         try
         {
            ...
            _deleteMiscItem.deleteMiscItem(sessionId, miId);
         } catch (Throwable e)
         {
            throw manageThrowable(e);
         }
     ...
     *         AdminConfigData items if the key is null. Items are returned ordered by date added
     *         (most recent first).
     * @throws KKAdminException
     *             an unexpected exception in the KonaKart Admin engine
     */
     ...
     * @throws KKAdminException
     *             an unexpected exception in the KonaKart Admin engine for any unexpected problems
     */
     ...
     *            <ul>
     *            <li>All products are read from the database in a loop to add to the catalog. You
     *            can define the maximum number of records read at a time. It can be changed for
     ...
     * @param vendor
     *            the vendor
     * @return Returns the numeric id of the inserted vendor object
     * @throws KKAdminException
     *             an unexpected exception in the KonaKart Admin engine
     */
     public int insertVendor(String sessionId, AdminVendor vendor) throws KKAdminException
     {
         try
         {
            ...
            {
                _insertVendor = new InsertVendor(kkAdminEng);
            }

            return _insertVendor.insertVendor(sessionId, vendor);
         } catch (Throwable e)
         {
            throw manageThrowable(e);
         }
    ...
    /**
     * Update a vendor. The vendor id of the vendor must be populated and a vendor must exist in the
     ...
     */
     public void updateVendor(String sessionId, AdminVendor vendor) throws KKAdminException
     {
         try
         {
            ...
            {
                _updateVendor = new UpdateVendor(kkAdminEng);
            }

            _updateVendor.updateVendor(sessionId, vendor);
         } catch (Throwable e)
         {
            throw manageThrowable(e);
         }
    ...
    /**
     * Search for vendors matching a set of search criteria within the AdminVendorSearch object. The
     * vendors may be sorted by :
     * <ul>
     * <li>AdminDataDescriptor.ORDER_BY_NAME_ASCENDING</li>
     * <li>AdminDataDescriptor.ORDER_BY_NAME_DESCENDING</li>
     * <li>AdminDataDescriptor.ORDER_BY_TAX_CODE_ASCENDING</li>
     * <li>AdminDataDescriptor.ORDER_BY_TAX_CODE_DESCENDING</li>
     * <li>AdminDataDescriptor.ORDER_BY_COMPANY_ID_ASCENDING</li>
     * <li>AdminDataDescriptor.ORDER_BY_COMPANY_ID_DESCENDING</li>
     * <li>AdminDataDescriptor.ORDER_BY_STOREID_ASCENDING</li>
     * <li>AdminDataDescriptor.ORDER_BY_STOREID_DESCENDING</li>
     * <li>AdminDataDescriptor.ORDER_BY_RATING_ASCENDING</li>
     * <li>AdminDataDescriptor.ORDER_BY_RATING_DESCENDING</li>
     * <li>AdminDataDescriptor.ORDER_BY_CUSTOM1_ASCENDING</li>
     * <li>AdminDataDescriptor.ORDER_BY_CUSTOM1_DESCENDING</li>
     ...
     *            The session Id of the logged in user
     * @param vendorSearch
     *            The definition of the search for vendors - can be null
     * @param offset
     *            The offset in the database
     * @param size
     *            The number of records from the specified offset
     * @return Returns a set of vendors customers matching the search criteria within an
     *         AdminVendorSearchResult object
     * @throws KKAdminException
     *             an unexpected exception in the KonaKart Admin engine
     */
     public AdminVendorSearchResult getVendors(String sessionId, AdminVendorSearch vendorSearch, int offset, int size) throws KKAdminException
     {
         try
         {
            if (_getVendors == null)
            {
                _getVendors = new GetVendors(kkAdminEng);
            }

            return _getVendors.getVendors(sessionId, vendorSearch, offset, size);
         } catch (Throwable e)
         {
            throw manageThrowable(e);
         }
     ...
     * @param vendorId
     *            the vendorId
     * @return Return a single vendor object referenced by the vendorId parameter, or null if it
     *         doesn't exist.
     * @throws KKAdminException
     *             an unexpected exception in the KonaKart Admin engine
     */
     public AdminVendor getVendorForId(String sessionId, int vendorId) throws KKAdminException
     {
         try
         {
            if (_getVendorForId == null)
            {
                _getVendorForId = new GetVendorForId(kkAdminEng);
            }

            return _getVendorForId.getVendorForId(sessionId, vendorId);
         } catch (Throwable e)
         {
            throw manageThrowable(e);
         }
     ...
     */
     public void deleteVendor(String sessionId, int vendorId) throws KKAdminException
     {
         try
         {
            ...
            {
                _deleteVendor = new DeleteVendor(kkAdminEng);
            }

            _deleteVendor.deleteVendor(sessionId, vendorId);
         } catch (Throwable e)
         {
            throw manageThrowable(e);
         }
     ...
     * <li>AdminDataDescriptor.ORDER_BY_CUSTOMERS_ID_ASCENDING</li>
     * <li>AdminDataDescriptor.ORDER_BY_CUSTOMERS_ID_DESCENDING</li>
     * <li>AdminDataDescriptor.ORDER_BY_VENDOR_ID_ASCENDING</li>
     * <li>AdminDataDescriptor.ORDER_BY_VENDOR_ID_DESCENDING</li>
     * </ul>
     * 
     * @param sessionId
     *            The session Id of the logged in user
     ...
     */
     public AdminReviews getVendorReviews(String sessionId, AdminDataDescriptor dataDesc, AdminReviewSearch revSearch) throws KKAdminException
     {
         try
         {
            if (_getVendorReviews == null)
            {
                _getVendorReviews = new GetVendorReviews(kkAdminEng);
            }

            return _getVendorReviews.getVendorReviews(sessionId, dataDesc, revSearch);
         } catch (Throwable e)
         {
            throw manageThrowable(e);
         }
     ...
     */
     public AdminReview getVendorReview(String sessionId, int reviewId) throws KKAdminException
     {
         try
         {
            if (_getVendorReview == null)
            {
                _getVendorReview = new GetVendorReview(kkAdminEng);
            }

            return _getVendorReview.getVendorReview(sessionId, reviewId);
         } catch (Throwable e)
         {
            throw manageThrowable(e);
         }
    ...
    /**
     * Returns the reviews for a vendor. The AdminDataDescriptor allows to add search constraints
     * for the custom fields 1 to 3 and to order the result set as follows:
     * <ul>
     * <li>AdminDataDescriptor.ORDER_BY_DATE_ADDED</li>
     * <li>AdminDataDescriptor.ORDER_BY_DATE_ADDED_DESCENDING</li>
     ...
     */
     public AdminReviews getReviewsPerVendor(String sessionId, AdminDataDescriptor dataDesc, int vendorId) throws KKAdminException
     {
         try
         {
            if (_getReviewsPerVendor == null)
            {
                _getReviewsPerVendor = new GetReviewsPerVendor(kkAdminEng);
            }

            return _getReviewsPerVendor.getReviewsPerVendor(sessionId, dataDesc, vendorId);
         } catch (Throwable e)
         {
            throw manageThrowable(e);
         }
    ...
    /**
     * Associates a vendor with a store. A check is made to see whether the store and vendor exist.
     * A <code>vendorId</code> of zero is accepted and represents the case where the store has no
     * associated vendor.
     * 
     * @param sessionId
     *            The session Id of the logged in user
     ...
     */
     public void addVendorToStore(String sessionId, int vendorId, String vendorStoreId) throws KKAdminException
     {
         try
         {
            if (_addVendorToStore == null)
            {
                _addVendorToStore = new AddVendorToStore(kkAdminEng);
            }

            _addVendorToStore.addVendorToStore(sessionId, vendorId, vendorStoreId);
         } catch (Throwable e)
         {
            throw manageThrowable(e);
         }
    ...
    /**
     * This API call is intended to provide a fast way to load catalog prices. In order to maximize
     * for speed, a check isn't made to see whether the product, productAttr and tierPrice ids
     * actually exist. For each price in the array, an attempt is first made to update the catalog
     * price. If it doesn't already exist in the database, it is inserted.
     * <p>
     * The options object allows you:
     * <ul>
     * <li>Manage the transaction. When the <code>singleTransaction</code> attribute is set to true,
     ...
     * exception is caught, but no rollback is performed. The default is false.</li>
     * <li>Decide whether to insert a product update event. When the <code>insertKKEvent</code>
     ...
     * up the new prices. The default is false.</li>
     * </ul>
     * 
     * @param sessionId
     *            The session Id of the logged in user
     * @param prices
     *            An array of AdminProductPrice objects
     * @param options
     ...
     */
     public void insertCatalogPrices(String sessionId, AdminProductPrice[] prices, AdminInsertCatalogPriceOptions options) throws KKAdminException
     {
         try
         {
            if (_insertCatalogPrices == null)
            {
                _insertCatalogPrices = new InsertCatalogPrices(kkAdminEng);
            }

            _insertCatalogPrices.insertCatalogPrices(sessionId, prices, options);
         } catch (Throwable e)
         {
            throw manageThrowable(e);
         }
     ...
     * multi-store single DB, non shared customer mode. The caller (referenced by sessionId) must
     * have at least one role with super user privileges. The cloneCustId references an existing
     * customer in the current engine store. If a customer with matching eMail address doesn't exist
     * in a destination store, a new customer object is inserted, otherwise the existing object is
     * updated.
     * <p>
     * Points to note:
     * <ul>
     * <li>The cloned customer has the same password as the source customer</li>
     * <li>All addresses and roles are also cloned</li>
     * <li>Customer tag information is cloned as long as the customer tag exists in the destination
     * store</li>
     * <li>The return object contains an array of error messages. If an error occurs when cloning to
     * a store, the exception is trapped, reported in the return object and the code continues with
     * the next store.</li>
     * </ul>
     * 
     * @param sessionId
     *            The session Id of the logged in user which must have Super User privileges.
     * @param cloneCustId
     *            The id of the customer to be cloned
     * @param stores
     *            An array of destination store ids where the customer will be cloned
     * @return Returns an AdminCloneCustomerResult object
     * @throws KKAdminException
     *             an unexpected exception in the KonaKart Admin engine
     */
     public AdminCloneCustomerResult cloneCustomer(String sessionId, int cloneCustId, String[] stores) throws KKAdminException
     {
         try
         {
            if (_cloneCustomer == null)
            {
                _cloneCustomer = new CloneCustomer(kkAdminEng);
            }

            return _cloneCustomer.cloneCustomer(sessionId, cloneCustId, stores);
         } catch (Throwable e)
         {
            throw manageThrowable(e);
         }
     ...
     * in multi-store single DB, non shared customer mode. The caller (referenced by sessionId) must
     * have at least one role with super user privileges. The customerId references an existing
     * customer in the current engine store. If a customer with matching eMail address exists in a
     * destination store, the customer is deleted.
     * <p>
     * If the stores array contains the id of the KKAdmin Engine store, then the customer is also
     * deleted from that store.
     * 
     * @param sessionId
     *            The session Id of the logged in user which must have Super User privileges.
     * @param customerId
     ...
     * @param stores
     *            An array of store ids where the customer will be deleted
     * @return Returns an AdminDeleteCustomerResult object
     * @throws KKAdminException
     *             an unexpected exception in the KonaKart Admin engine
     */
     public AdminDeleteCustomerResult deleteCustomerMultiStore(String sessionId, int customerId, String[] stores) throws KKAdminException
     {
         try
         {
            if (_deleteCustomerMultiStore == null)
            {
                _deleteCustomerMultiStore = new DeleteCustomerMultiStore(kkAdminEng);
            }

            return _deleteCustomerMultiStore.deleteCustomerMultiStore(sessionId, customerId, stores);
         } catch (Throwable e)
         {
            throw manageThrowable(e);
         }
    ...
    /**
     * This API call is only available when in multi-store single DB, non shared customer mode. The
     * caller (referenced by sessionId) must have at least one role with super user privileges.
     * <p>
     * It is used to search for a customer using the email address, across multiple stores. The
     * stores where the customer is present, are returned in an array in alphabetical order. It
     * searches all stores regardless of their state (enabled, under maintenance or deleted). This
     * state information is available on the returned AdminStore objects.
     * 
     * @param sessionId
     *            The session Id of the logged in user which must have Super User privileges.
     * @param emailAddress
     *            The email address of the customer being searched
     * @return Returns an array of AdminStores. An empty array is returned if there are no stores.
     * @throws KKAdminException
     *             an unexpected exception in the KonaKart Admin engine
     */
     public AdminStore[] getStoresForCustomer(String sessionId, String emailAddress) throws KKAdminException
     {
         try
         {
            if (_getStoresForCustomer == null)
            {
                _getStoresForCustomer = new GetStoresForCustomer(kkAdminEng);
            }

            return _getStoresForCustomer.getStoresForCustomer(sessionId, emailAddress);
         } catch (Throwable e)
         {
            throw manageThrowable(e);
         }
     ...
     * <p>
     * The suggestions that are retrieved are defined by the suggestion parameter. The where clause
     * for the select will be created by using the values in the suggestion parameter.
     * 
     * @param sessionId
     *            The session Id of the logged in user
     * @param suggestion
     ...
     * @param dataDesc
     *            data descriptor for defining generic search parameters such as size and offset
     * @return an AdminSuggestionSearchResult that contains the result of the search
     * @throws KKAdminException
     *             an unexpected exception in the KonaKart Admin engine
     */
     public AdminSuggestionSearchResult getSuggestions(String sessionId, AdminSuggestion suggestion, AdminDataDescriptor dataDesc) throws KKAdminException
     {
         try
         {
            if (_getSuggestions == null)
            {
                _getSuggestions = new GetSuggestions(kkAdminEng);
            }

            return _getSuggestions.getSuggestions(sessionId, suggestion, dataDesc);
         } catch (Throwable e)
         {
            throw manageThrowable(e);
         }
    ...
    /**
     * This inserts Product Recommendation AdminSuggestion objects into the database. The
     * suggestionType attribute must be set in the AdminSuggestion objects in the array.
     * <p>
     * For Product Suggestion types the boughtProductId attribute must be set on the AdminSuggestion
     * objects.
     * <p>
     * For Customer Suggestion types the customerId attribute must be set on the AdminSuggestion
     * objects.
     * 
     * @param sessionId
     *            The session Id of the logged in user
     * @param suggestions
     *            An array of AdminSuggestion objects
     * @throws KKAdminException
     *             an unexpected exception in the KonaKart Admin engine
     */
     public void insertSuggestions(String sessionId, AdminSuggestion[] suggestions) throws KKAdminException
     {
         try
         {
            if (_insertSuggestions == null)
            {
                _insertSuggestions = new InsertSuggestions(kkAdminEng);
            }

            _insertSuggestions.insertSuggestions(sessionId, suggestions);
         } catch (Throwable e)
         {
            throw manageThrowable(e);
         }
    ...
    /**
     * This deletes Product Recommendation Suggestion records from the database. The suggestions
     * that are deleted are defined by the AdminSuggestion record. The where clause for the delete
     * will be created by using the values in the AdminSuggestion.
     * 
     * @param sessionId
     *            The session Id of the logged in user
     * @param suggestion
     *            An AdminSuggestion object that is used to specify the records to delete.
     * @throws KKAdminException
     *             an unexpected exception in the KonaKart Admin engine
     */
     public void deleteSuggestions(String sessionId, AdminSuggestion suggestion) throws KKAdminException
     {
         try
         {
            if (_deleteSuggestions == null)
            {
                _deleteSuggestions = new DeleteSuggestions(kkAdminEng);
            }

            _deleteSuggestions.deleteSuggestions(sessionId, suggestion);
         } catch (Throwable e)
         {
            throw manageThrowable(e);
         }
    ...
    /**
     * Returns an <code>AdminOrderReturnStatusSearchResult</code> object.
     * 
     * @param search
     *            the search object that defines the search parameters and sort order. If
     *            <code>languageId</code> is not set (or set to
     ...
     *            <code>languageId</code> is set to <code>AdminLanguageMgr.ALL_LANGUAGES</code> all
     *            languages are returned.
     * @return Returns an <code>AdminOrderReturnStatusSearchResult</code>
     * @throws KKAdminException
     *             an unexpected exception in the KonaKart Admin engine
     */
     public AdminOrderReturnStatusSearchResult getOrderReturnStatuses( AdminOrderReturnStatusSearch search) throws KKAdminException
     {
         try
         {
            if (_getOrderReturnStatuses == null)
            {
                _getOrderReturnStatuses = new GetOrderReturnStatuses(kkAdminEng);
            }

            return _getOrderReturnStatuses.getOrderReturnStatuses(search);
         } catch (Throwable e)
         {
            throw manageThrowable(e);
         }
     ...
     * @param id
     *            An OrderStatus id
     * @return returns the id of the deleted OrderReturnStatus object
     * @throws KKAdminException
     *             an unexpected exception in the KonaKart Admin engine
     */
     public int deleteOrderReturnStatus(String sessionId, int id) throws KKAdminException
     {
         try
         {
            if (_deleteOrderReturnStatus == null)
            {
                _deleteOrderReturnStatus = new DeleteOrderReturnStatus(kkAdminEng);
            }

            return _deleteOrderReturnStatus.deleteOrderReturnStatus(sessionId, id);
         } catch (Throwable e)
         {
            throw manageThrowable(e);
         }
    ...
    /**
     * Insert an OrderReturnStatus object. You may select the order status id or alternatively set
     * the id of the object to -1 in order for the system to assign an Id. An exception will be
     * thrown if the selected id already exists.
     * 
     * @param sessionId
     *            The session Id of the logged in user
     * @param status
     *            An OrderReturnStatus object
     * @return returns the order status id of the inserted object
     * @throws KKAdminException
     *             an unexpected exception in the KonaKart Admin engine
     */
     public int insertOrderReturnStatus(String sessionId, AdminOrderReturnStatus status) throws KKAdminException
     {
         try
         {
            if (_insertOrderReturnStatus == null)
            {
                _insertOrderReturnStatus = new InsertOrderReturnStatus(kkAdminEng);
            }

            return _insertOrderReturnStatus.insertOrderReturnStatus(sessionId, status);
         } catch (Throwable e)
         {
            throw manageThrowable(e);
         }
    ...
    /**
     * Insert an array of AdminOrderReturnStatus objects. This method is useful to insert an object
     * for each language defined in the system. All members of the array must have the same order
     * status id. You may select the order status id or alternatively set the id of the objects to
     * -1 in order for the system to assign an Id. An exception will be thrown if the selected id
     * already exists.
     ...
     *            The session Id of the logged in user
     * @param statuses
     *            An array of AdminOrderReturnStatus objects
     * @return returns the order status id of the inserted AdminOrderReturnStatus objects
     * @throws KKAdminException
     *             an unexpected exception in the KonaKart Admin engine
     */
     public int insertOrderReturnStatuses(String sessionId, AdminOrderReturnStatus[] statuses) throws KKAdminException
     {
         try
         {
            if (_insertOrderReturnStatuses == null)
            {
                _insertOrderReturnStatuses = new InsertOrderReturnStatuses(kkAdminEng);
            }

            return _insertOrderReturnStatuses.insertOrderReturnStatuses(sessionId, statuses);
         } catch (Throwable e)
         {
            throw manageThrowable(e);
         }
     ...
     */
     public int updateOrderReturnStatus(String sessionId, AdminOrderReturnStatus status) throws KKAdminException
     {
         try
         {
            if (_updateOrderReturnStatus == null)
            {
                _updateOrderReturnStatus = new UpdateOrderReturnStatus(kkAdminEng);
            }

            return _updateOrderReturnStatus.updateOrderReturnStatus(sessionId, status);
         } catch (Throwable e)
         {
            throw manageThrowable(e);
         }
    ...
    /**
     * Returns an array of AdminOrderReturnStatus objects for the specified languageId. Use
     * AdminLanguageMgr.ALL_LANGUAGES to retrieve the Order Status Names for All languages.
     * 
     * @param languageId
     *            the languageId
     * @return an array of AdminOrderReturnStatus objects for the specified languageId.
     * @throws KKAdminException
     *             an unexpected exception in the KonaKart Admin engine
     */
     public AdminOrderReturnStatus[] getAllOrderReturnStatuses(int languageId) throws KKAdminException
     {
         try
         {
            if (_getAllOrderReturnStatuses == null)
            {
                _getAllOrderReturnStatuses = new GetAllOrderReturnStatuses(kkAdminEng);
            }

            return _getAllOrderReturnStatuses.getAllOrderReturnStatuses(languageId);
         } catch (Throwable e)
         {
            throw manageThrowable(e);
         }
