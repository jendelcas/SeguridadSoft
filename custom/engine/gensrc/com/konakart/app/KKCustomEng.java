...
public class KKCustomEng implements com.konakart.appif.KKEngIf
{
     ...
     */
     ...
     private EditCustomerWithOptions _editCustomerWithOptions = null;
     ...
     private NotifySysAdmin _notifySysAdmin = null;
     ...
     private GetStoreForId _getStoreForId = null;
     ...
     private GetAddressesPerVendor _getAddressesPerVendor = null;
     ...
     private CheckFileAccess _checkFileAccess = null;
     private IsCustomerSubscribedToNewsletter _isCustomerSubscribedToNewsletter = null;
     private GetSuggestions _getSuggestions = null;
     private GetMiscItemsPerType _getMiscItemsPerType = null;
     private GetAllProductRelationships _getAllProductRelationships = null;
    ...
    */
     ...
     * <li>DataDescConstants.ORDER_BY_EXPIRY_DATE_ASCENDING</li>
     * <li>DataDescConstants.ORDER_BY_EXPIRY_DATE_DESCENDING</li>
     ...
     * com.konakart.bl.CustomerMgr.DEFAULT_STRING</li>
     * <li>noBirthDate - The birth date is populated with
     * com.konakart.bl.CustomerMgr.DEFAULT_DOB</li>
     ...
     * </ul>
     * By default a check is made to determine whether the eMail address in the CustomerRegistration
     * object is unique. By setting the <code>telephoneUnique</code> and
     * <code>telephone1Unique</code> attributes of the CustomerRegistration object you can instruct
     ...
     * <code>allowMultipleRegistrations</code> to true in the <code>CustomerRegistration</code>
     ...
     * 
     * @param emailAddr
     *            The username required to log in
     * @param password
     *            The log in password
     ...
     * to be changed. When successful, the LoginResult contains the session key.
     * <p>
     * The input object allows you to set either the email address, username, telephone number or
     * telephone number 1 as the username. Only one of these must contain a non null value,
     ...
     */
     public void editCustomerWithOptions(String sessionId, CustomerIf cust, EditCustomerOptionsIf options) throws KKException
     {
         try
         {
            if (_editCustomerWithOptions == null)
            {
                _editCustomerWithOptions = new EditCustomerWithOptions(kkEng);
            }

            _editCustomerWithOptions.editCustomerWithOptions(sessionId, cust, options);
         } catch (Throwable e)
         {
            throw manageThrowable(e);
         }
     ...
     * @return Returns an Email object containing only the email address specified
     * @throws KKException
     *             an unexpected KKException exception
     */
     ...
     * @param options
     *            Options for the email
     * @return Returns an Email object containing only the email address
     * @throws KKException
     *             an unexpected KKException exception
     */
     ...
     * 
     * @param emailAddr
     *            The username in the format of an email address
     ...
     * <p>
     * The caller supplies the username (email address) and password of the KonaKart user. If the
     ...
     * 
     * @param emailAddr
     *            The username of the customer creating the order
     * @param password
     ...
     * parameter. If the customerId doesn't reference a registered customer, and the
     * <code>emailAddr</code> is set on the options object, the email is sent to the emailAddr
     ...
     * <li><code>deleteAttachmentAfterSend</code>: When set to <code>true</code>, the attachment is
     * deleted after being sent. The default value is <code>false</code>.</li>
     * <li><code>emailAddr</code>: When the customerId doesn't reference a registered customer and
     * emailAddr is set, then the email is sent to the emailAddr address . Note that in this case
     * the Velocity context will not contain the customer details since these aren't available.</li>
     * </ul>
     * <p>
     * The Velocity context contains the following data:
     * <ul>
     * <li><code>customerName</code>: The name of the customer in the format firstName lastName</li>
     * <li><code>customer</code>: The CustomerIf object</li>
     * <li><code>emailAddr</code>: The email address of the customer where the mail has been
     * sent</li>
     ...
     * @param options
     *            Options for the email
     * @return Returns an Email object containing only the email address or a null if the
     *         SEND_EMAILS configuration variable is false.
     * @throws KKException
     *             an unexpected KKException exception
     */
    ...
    /**
     * This method is used to send a template based eMail to the System Administrator. The System
     * Administrator's email address is defined in the SYSADMIN_EMAIL_ADDRESS configuration
     * variable.
     * <p>
     * Valid options are:
     * <ul>
     ...
     */
     public EmailIf notifySysAdmin(String message, EmailOptionsIf options) throws KKException
     {
         try
         {
            if (_notifySysAdmin == null)
            {
                _notifySysAdmin = new NotifySysAdmin(kkEng);
            }

            return _notifySysAdmin.notifySysAdmin(message, options);
         } catch (Throwable e)
         {
            throw manageThrowable(e);
         }
    ...
    /**
     * Returns the store referenced by the vendorStoreId parameter. It can only be called when in
     * multi-vendor mode which assumes there is a single DB and products are shared.
     * 
     * @param vendorStoreId
     *            the vendorStoreId
     * @return Returns a Store object or null if the store isn't found
     ...
     */
     public StoreIf getStoreForId(String vendorStoreId) throws KKException
     {
         try
         {
            if (_getStoreForId == null)
            {
                _getStoreForId = new GetStoreForId(kkEng);
            }

            return _getStoreForId.getStoreForId(vendorStoreId);
         } catch (Throwable e)
         {
            throw manageThrowable(e);
         }
     ...
     * <code>com.konakart.app.CustomerTag.MULTI_INT_TYPE</code> or
     * <code>MULTI_INT_PLUS_TIME_TYPE</code>. This customer tag type is used to store a series of
     ...
     * <p>
     * In the case of <code>MULTI_INT_PLUS_TIME_TYPE</code> tags, the timestamp component is added
     ...
     * inserted that calls a payment gateway.
     * <p>
    ...
    /**
     * This API call is used to retrieve a single promotion matching an id or name. Depending on how
     ...
     *            negative number in order to search for the promotion using the promotion name.
     * @param promotionName
     ...
     *            categories and manufacturers. Value of -1 selects the default language.
     * @param prmOptions
     *            A FetchPromotionOptions object used to configure the API call. It may be set to
     *            null for default functionality.
     * @param prodOptions
     *            A FetchProductOptions used to configure the products (if any) attached to the
     *            promotion. It may be set to null for default functionality.
     * @return Returns a fully populated promotion object
     * @throws KKException
     *             an unexpected KKException exception
     */
     public PromotionIf getPromotion(int promotionId, String promotionName, int languageId, FetchPromotionOptionsIf prmOptions, FetchProductOptionsIf prodOptions) throws KKException
     {
         try
         {
            ...
            {
                _getPromotion = new GetPromotion(kkEng);
            }

            return _getPromotion.getPromotion(promotionId, promotionName, languageId, prmOptions, prodOptions);
         } catch (Throwable e)
         {
            throw manageThrowable(e);
         }
     ...
     * 
     * @param vendor
     *            - Only the vendorId and the defaultAddrId are used
     * @return Returns an array of address objects where the first one is the primary address. The
     *         other addresses are ordered by descending ADDRESS_BOOK_ID. Returns an empty array if
     *         no addresses exist.
     * @throws KKException
     *             an unexpected KKException exception
     */
     public AddressIf[] getAddressesPerVendor(VendorIf vendor) throws KKException
     {
         try
         {
            if (_getAddressesPerVendor == null)
            {
                _getAddressesPerVendor = new GetAddressesPerVendor(kkEng);
            }

            return _getAddressesPerVendor.getAddressesPerVendor(vendor);
         } catch (Throwable e)
         {
            throw manageThrowable(e);
         }
     ...
     * criteria in the VendorSearch object. The vendor default address is populated if it exists. It
     * allows you to search for:
     * <ul>
     * <li>A vendor for a given vendor Id</li>
     * <li>A vendor for a given store Id</li>
     * <li>A vendor for a given name</li>
     * <li>A vendor for a given company Id</li>
     * <li>A vendor for a given company tax Id</li>
     * <li>Vendors matching, above or below a given rating</li>
     * </ul>
     * <p>
     * <code>dataDesc</code> controls the following functionality:
     * <ul>
     * <li>The maximum number of Vendor objects returned.</li>
     * <li>The offset which defaults to zero. This is useful when there are many Vendor objects, in
     * order to return them using multiple calls to this method.</li>
     * <li>Criteria on the custom attributes. If a custom attribute is set, then only vendors with a
     * matching custom attribute value are returned.</li>
     * <li>The Vendors may be sorted by :
     * <ul>
     * <li>com.konakart.app.DataDescConstants.ORDER_BY_ID_ASCENDING</li>
     * <li>com.konakart.app.DataDescConstants.ORDER_BY_ID_DESCENDING</li>
     * <li>com.konakart.app.DataDescConstants.ORDER_BY_NAME_ASCENDING</li>
     * <li>com.konakart.app.DataDescConstants.ORDER_BY_NAME_DESCENDING</li>
     * <li>com.konakart.app.DataDescConstants.ORDER_BY_TAX_CODE_ASCENDING</li>
     * <li>com.konakart.app.DataDescConstants.ORDER_BY_TAX_CODE_DESCENDING</li>
     * <li>com.konakart.app.DataDescConstants.ORDER_BY_COMPANY_ID_ASCENDING</li>
     * <li>com.konakart.app.DataDescConstants.ORDER_BY_COMPANY_ID_ASCENDING</li>
     * <li>com.konakart.app.DataDescConstants.ORDER_BY_RATING_ASCENDING</li>
     * <li>com.konakart.app.DataDescConstants.ORDER_BY_RATING_DESCENDING</li>
     * <li>com.konakart.app.DataDescConstants.ORDER_BY_CUSTOM1_ASCENDING</li>
     ...
     *            fields and offset and limit for paging.
     * @param search
     *            The Vendor search object that defines the search criteria
     * @return Returns a Vendors object containing the return data
     * @throws KKException
     *             an unexpected KKException exception
     */
     public VendorsIf getVendors(DataDescriptorIf dataDesc, VendorSearchIf search) throws KKException
     {
         try
         {
            if (_getVendors == null)
            {
                _getVendors = new GetVendors(kkEng);
            }

            return _getVendors.getVendors(dataDesc, search);
         } catch (Throwable e)
         {
            throw manageThrowable(e);
         }
    ...
    /**
     * Returns the vendor object for the vendor defined by the given vendorId. The vendor default
     * address is populated if it exists.
     * 
     * @param vendorId
     *            The numeric vendor id
     * @return Returns a Vendor object or Null if the vendor doesn't exist.
     * @throws KKException
     *             an unexpected KKException exception
     */
     public VendorIf getVendorForId(int vendorId) throws KKException
     {
         try
         {
            ...
            {
                _getVendorForId = new GetVendorForId(kkEng);
            }

            return _getVendorForId.getVendorForId(vendorId);
         } catch (Throwable e)
         {
            throw manageThrowable(e);
         }
     ...
     * <ul>
     * <li>A review for a given reviewId</li>
     * <li>All reviews for a vendor identified by the vendorId</li>
     * <li>All reviews written by a customer identified by the customerId</li>
     * <li>All reviews matching, above or below a given rating</li>
     * </ul>
     * <p>
     ...
     * <li>com.konakart.app.DataDescConstants.ORDER_BY_DATE_ADDED_DESCENDING</li>
     * <li>com.konakart.app.DataDescConstants.ORDER_BY_DATE_ADDED_ASCENDING</li>
     * <li>com.konakart.app.DataDescConstants.ORDER_BY_LAST_MODIFIED_DESCENDING</li>
     * <li>com.konakart.app.DataDescConstants.ORDER_BY_LAST_MODIFIED_ASCENDING</li>
     * <li>com.konakart.app.DataDescConstants.ORDER_BY_TIMES_READ_DESCENDING</li>
     * <li>com.konakart.app.DataDescConstants.ORDER_BY_TIMES_READ_ASCENDING</li>
     * <li>com.konakart.app.DataDescConstants.ORDER_BY_RATING_DESCENDING</li>
     * <li>com.konakart.app.DataDescConstants.ORDER_BY_RATING_ASCENDING</li>
     ...
     */
     public ReviewsIf getVendorReviews(DataDescriptorIf dataDesc, ReviewSearchIf search) throws KKException
     {
         try
         {
            ...
            {
                _getVendorReviews = new GetVendorReviews(kkEng);
            }

            return _getVendorReviews.getVendorReviews(dataDesc, search);
         } catch (Throwable e)
         {
            throw manageThrowable(e);
         }
     ...
     */
     public ReviewIf getVendorReview(int reviewId) throws KKException
     {
         try
         {
            ...
            {
                _getVendorReview = new GetVendorReview(kkEng);
            }

            return _getVendorReview.getVendorReview(reviewId);
         } catch (Throwable e)
         {
            throw manageThrowable(e);
         }
     ...
     */
     public ReviewsIf getReviewsPerVendor(DataDescriptorIf dataDesc, int vendorId) throws KKException
     {
         try
         {
            ...
            {
                _getReviewsPerVendor = new GetReviewsPerVendor(kkEng);
            }

            return _getReviewsPerVendor.getReviewsPerVendor(dataDesc, vendorId);
         } catch (Throwable e)
         {
            throw manageThrowable(e);
         }
    ...
    /**
     * Check that we allow access to this location. Permitted locations are specified in the
     * konakart.properties file
     * 
     * @param fileName
     *            the file to be accessed (read or written)
     * @throws Exception
     ...
     */
     public void checkFileAccess(String fileName) throws Exception
     {
         try
         {
            if (_checkFileAccess == null)
            {
                _checkFileAccess = new CheckFileAccess(kkEng);
            }

            _checkFileAccess.checkFileAccess(fileName);
         } catch (Throwable e)
         {
            throw manageThrowable(e);
         }
     ...
     * the <code>emailAddr</code> parameter is subscribed to receive the newsletter.
     * 
     * @param emailAddr
     *            The email address of the customer we are checking
     * @return Returns true if the customer is subscribed
     * @throws KKException
     *             an unexpected KKException exception
     */
     public boolean isCustomerSubscribedToNewsletter(String emailAddr) throws KKException
     {
         try
         {
            if (_isCustomerSubscribedToNewsletter == null)
            {
                _isCustomerSubscribedToNewsletter = new IsCustomerSubscribedToNewsletter(kkEng);
            }

            return _isCustomerSubscribedToNewsletter.isCustomerSubscribedToNewsletter(emailAddr);
         } catch (Throwable e)
         {
            throw manageThrowable(e);
         }
    ...
    /**
     * This retrieves Product Recommendation Suggestion objects from the database. The suggestion
     * parameter defines the records to be returned.
     * <p>
     * The where clause for the select will be created by using the values in the suggestion
     * parameter.
     * 
     * @param sessionId
     *            The session id of the logged in user
     ...
     */
     public SuggestionIf[] getSuggestions(String sessionId, SuggestionIf suggestion, DataDescriptorIf dataDesc) throws KKException
     {
         try
         {
            ...
            {
                _getSuggestions = new GetSuggestions(kkEng);
            }
     ...
     * @param languageId
     *            the languageId
     * @return Returns an array of MiscItems objects or an empty array
     * @throws KKException
     *             an unexpected exception
     */
     public MiscItemIf[] getMiscItemsPerType(int typeId, int languageId) throws KKException
     {
         try
         {
            if (_getMiscItemsPerType == null)
            {
                _getMiscItemsPerType = new GetMiscItemsPerType(kkEng);
            }

            return _getMiscItemsPerType.getMiscItemsPerType(typeId, languageId);
         } catch (Throwable e)
         {
            throw manageThrowable(e);
         }
    ...
    /**
     * A fast utility to returns all product relationships in the products_to_products table. Paging is
     * not available so it should be called when it is known that only a limited number of product
     * relationships exist. Note that it doesn't filter the products by store id or check whether
     * the products actually belong to a certain store, so this check should be done by the caller
     * before using the data.
     * 
     * @return Returns an array of ProductRelationship objects
     * @throws KKException
     *             an unexpected exception
     */
     public ProductRelationshipIf[] getAllProductRelationships() throws KKException
     {
         try
         {
            if (_getAllProductRelationships == null)
            {
                _getAllProductRelationships = new GetAllProductRelationships(kkEng);
            }

            return _getAllProductRelationships.getAllProductRelationships();
         } catch (Throwable e)
         {
            throw manageThrowable(e);
         }
