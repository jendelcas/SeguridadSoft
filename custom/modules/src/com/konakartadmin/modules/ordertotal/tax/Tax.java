...
public class Tax extends OrderTotalModule
{
    ...
    public KKConfiguration[] getConfigs()
    {
        ...
        Date now = getKonakartTimeStampDate();
        ...
        configs[i++] = new KKConfiguration("Sort Order", "MODULE_ORDER_TOTAL_TAX_SORT_ORDER", "39",
                "Sort order of display.", 6, 2, "", "", now);
        configs[i++] = new KKConfiguration("New OT for each tax rate?", "MODULE_ORDER_TOTAL_TAX_MULTIPLE_LINES", "false",
                "Do you want to have multiple order totals for different tax rates? Tax code must be set on tax class", 6, 3, "",
                "choice('true'='true','false'='false')", now);
        return configs;
    }
}
