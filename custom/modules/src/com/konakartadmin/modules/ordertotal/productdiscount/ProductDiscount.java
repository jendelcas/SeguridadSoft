...
public class ProductDiscount extends OrderTotalModule
{
    ...
    public KKConfiguration[] getConfigs()
    {
        ...
        configs[i] = new KKConfiguration(
        /* title */"Non Cumulative Behaviour",
        /* key */"MODULE_ORDER_TOTAL_PRODUCT_DISCOUNT_NON_CUMULATIVE_BEHAVIOUR",
        /* value */"custom6",
        /* description */"Determines whether the discount is calculated for each promotion or each product"
                + " before deciding which discount to choose.",
        /* groupId */groupId,
        /* sortO */i++,
        /* useFun */"invisible",
        /* setFun */"choice('true'='Product','false'='Promotion')",
        /* dateAdd */now);
