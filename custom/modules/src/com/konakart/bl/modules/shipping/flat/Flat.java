...
{// Module name must be the same as the class name although it can be all in lowercase
    ...
    public ShippingQuote getQuote(Order order, ShippingInfo info) throws Exception
    {
        ...
        if (sd.getTaxClass() > 0)
        {
            ...
            quote.setTax(taxMgr.getTax(sd.getCost(), info.getDeliveryCountry().getId(),
    ...
    public void setStaticVariables() throws KKException
    {
        ...
        staticData.setSortOrder(
                getConfigurationValueAsIntWithDefault(MODULE_SHIPPING_FLAT_SORT_ORDER, 0));
        staticData.setTaxClass(
                getConfigurationValueAsIntWithDefault(MODULE_SHIPPING_FLAT_TAX_CLASS, 0));
