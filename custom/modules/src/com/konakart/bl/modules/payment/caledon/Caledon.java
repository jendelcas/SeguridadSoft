...
public class Caledon extends BasePaymentModule implements PaymentInterface
{
    ...
    private static boolean sslSetup = false;
    ...
    public void setStaticVariables() throws KKException
    {
        ...
        staticData.setSortOrder(
                getConfigurationValueAsIntWithDefault(MODULE_PAYMENT_CALEDON_SORT_ORDER, 0));
    ...
    {
        setupDefaultSSLProtocol("TLSv1.2");
        ...
        parmList.add(new NameValue("REF",
                order.getId() + "-"
    ...
    protected void setupDefaultSSLProtocol(String protocol)
    {
        if (!sslSetup)
        {
            try
            ...
            {
                log.warn("Problem setting up " + protocol + " as default SSL protocol: "
