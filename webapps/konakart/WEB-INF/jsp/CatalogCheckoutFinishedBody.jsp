			    		...
			    		<form action="CheckoutFinishedSubmit.action" id="form1" method="post">
							...
							<div class="form-section">
								<div class="notification-header">
									<%if (pd.getCode() != null && pd.getCode().equals(com.konakart.bl.modules.payment.banktransfer.BankTransfer.code)) { %>
										<kk:msg  key="checkout.finished.bank.transfer" arg0="<%=pd.getCustom1()%>" arg1="<%=pd.getCustom2()%>" arg2="<%=pd.getCustom3()%>"/>.
									<% } else {%>
