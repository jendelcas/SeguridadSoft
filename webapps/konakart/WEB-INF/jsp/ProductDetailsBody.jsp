...
<% String title = "";%>
<% String contentForSpecsTab = kkEng.getConfig(com.konakart.util.KKConstants.CONFIG_CONTENT_FOR_SPECS_TAB,/*tryEngIfNotInCache*/false); %>
    		...
    		<div id="product-column-left">
	    		...
	    		<div id="product-content">
					...
					<div id="product-specifications">	
	    				<%if (contentForSpecsTab != null && contentForSpecsTab.equals(com.konakart.util.KKConstants.CONTENT_COMPARISON_DATA)){ %>
							<p style="clear:both"><%=(prod.getComparison() == null)?"":prod.getComparison()%></p>												
						<% } else { %>
		    					...
		    					<% for (int i = 5; i > 0; i--){ %>
			    					...
			    					<div class="average-customer-reviews-meter-container">
			    						<div class="average-customer-reviews-meter-label">
			    							<%if (qty > 0){ %> 
												<a href='<%="FilterRev.action?rating="+i+"&t="+revMgr.getRevTimestamp()%>'>
