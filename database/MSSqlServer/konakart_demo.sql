...
-- Created: Thu Dec 23 11:25:53 GMT 2021
-- -----------------------------------------------------------
-- 
...
CREATE TABLE customers (
  ...
  customers_password NVARCHAR(96) NOT NULL,
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, use_function, date_added) VALUES ('Set Order Status', 'MODULE_PAYMENT_COD_ORDER_STATUS_ID', '0', 'Set the status of orders made with this payment module to this value', '6', '0', 'OrderStatuses', 'tep_get_order_status_name', getdate());
...
INSERT INTO currencies VALUES ('Euro','EUR','','EUR','.',',','2','1.1000', getdate());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES                ('Image base path','IMG_BASE_PATH','C:/KonaKart/webapps/konakart/images','The base path where application images are saved','4', '10', getdate());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES                ('Report definitions base path','REPORTS_DEFN_PATH','C:/KonaKart/webapps/birt-viewer/reports/','The reports definition location','17', '1', getdate());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('KonaKart Log file Directory', 'KONAKART_LOG_FILE_DIRECTORY', 'C:/KonaKart/logs', 'The location where KonaKart will write diagnostic log files', '20', '2', getdate());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Use Solr Search Server','USE_SOLR_SEARCH','false','Use Solr search server to search for products','24', '10', 'choice(''true''=''true'',''false''=''false'')', getdate());
DELETE FROM configuration WHERE configuration_key = 'SOLR_URL';
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Base URL of Solr Search Server','SOLR_URL','http://localhost:8983/','Base URL of Solr Search Server','24', '30', getdate());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES                ('KonaKart new store creation SQL','KK_NEW_STORE_SQL_FILENAME','C:/KonaKart/database/MySQL/konakart_new_store.sql','Filename containing the KonaKart new store creation SQL commands','25', '10', getdate());
DELETE FROM configuration WHERE configuration_key = 'USER_NEW_STORE_SQL_FILENAME';
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES                ('User new store creation SQL','USER_NEW_STORE_SQL_FILENAME','C:/KonaKart/database/MySQL/konakart_user_new_store.sql','Filename containing the user defined new store creation SQL commands - these are executed after the KonaKart cloning commands','25', '11', getdate());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('KonaKart Installation Home', 'INSTALLATION_HOME','C:/KonaKart/','The home directory of this KonaKart Installation', '1', '26', getdate());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('PDF Directory', 'PDF_BASE_DIRECTORY', 'C:/KonaKart/pdf/', 'Defines the root directory for the location of the PDF documents that are created', '27', '5', getdate());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Exported Orders Directory', 'EXPORT_ORDERS_BASE_DIRECTORY', 'C:/KonaKart/orders', 'Defines the root directory where the Orders are exported to', '7', '7', getdate());
...
ALTER TABLE products_description ALTER COLUMN products_name NVARCHAR(150);
...
ALTER TABLE categories_description ALTER COLUMN categories_name VARCHAR(150);

-----------------  v5.8.0.0

-- Extend the size of the products_name field
ALTER TABLE orders_products ALTER COLUMN products_name NVARCHAR(150);
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, return_by_api) VALUES ('Suggested Search prepend regex','SOLR_TERMS_PRE_REGEX','.*','Regex prepended to search string used for searching within SOLR term','24', '100', getdate(), '0');
DELETE FROM configuration WHERE configuration_key = 'SOLR_TERMS_POST_REGEX';
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, return_by_api) VALUES ('Suggested Search append regex','SOLR_TERMS_POST_REGEX','.*','Regex appended to search string used for searching within SOLR term','24', '110', getdate(), '0');
DELETE FROM configuration WHERE configuration_key = 'SOLR_DELETE_ON_COMMIT';
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, return_by_api) VALUES ('Delete from index on commit','SOLR_DELETE_ON_COMMIT','true','On commit, delete from index products marked for deletion','24', '70', 'choice(''true''=''true'',''false''=''false'')', getdate(), '0');
...
INSERT INTO products ( products_model, products_price, products_weight, products_status, products_tax_class_id, manufacturers_id, products_quantity, products_ordered, products_date_added, products_date_available) VALUES ( 'WIN10', 129.99, 6, 1, 1, 2, 100, 0, getdate(), getdate());
...
INSERT INTO products ( products_model, products_price, products_weight, products_status, products_tax_class_id, manufacturers_id, products_quantity, products_ordered, products_date_added, products_date_available) VALUES ( 'IPHONEXS', 999.99, 3, 1, 1, 14, 100, 0, getdate(), getdate());
...
INSERT INTO products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) VALUES (47, 2, 'iPhone XS', 'iPhone XS ist mit unglaublichen Spezifikationen verpackt. Das 5,8-Zoll-Super-Retina-HD-Display sieht umwerfend aus, die 12-Megapixel-Dual-Lens-Kamera bietet atemberaubende Porträts mit fortschrittlichen Bokeh-Effekten und bietet Speicherplatz bis zu 512 GB - mehr als jedes iPhone.','https://www.apple.com/de/iphone-xs/',0);
INSERT INTO products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) VALUES (47, 3, 'iPhone XS', 'iPhone XS está repleto de especificaciones increíbles. La pantalla Super Retina HD de 5.8 pulgadas se ve increíble, la cámara de lente doble de 12 megapíxeles toma retratos asombrosos con efectos de bokeh avanzados y ofrece almacenamiento de hasta 512 GB, más que cualquier otro iPhone anterior.','https://www.apple.com/es/iphone-xs/',0);
INSERT INTO products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) VALUES (47, 4, 'iPhone XS', 'O iPhone XS é embalado com especificações incríveis. A tela Super Retina HD de 5,8 polegadas parece incrível, a câmera de lente dupla de 12MP tira retratos impressionantes com efeitos bokeh avançados, e oferece armazenamento de até 512GB - mais do que qualquer iPhone anterior.','https://www.apple.com/pt/iphone-xs/',0);
...
INSERT INTO products ( products_model, products_price, products_weight, products_status, products_tax_class_id, manufacturers_id, products_quantity, products_ordered, products_date_added, products_date_available) VALUES ( 'WB1100F', 155.99, 1, 1, 1, 21, 100, 0, getdate(), getdate());
...
INSERT INTO products ( products_model, products_price, products_weight, products_status, products_tax_class_id, manufacturers_id, products_quantity, products_ordered, products_date_added, products_date_available) VALUES ( 'GALTABS4', 699.99, 2, 1, 1, 21, 100, 0, getdate(), getdate());
...
INSERT INTO products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) VALUES (61, 2, 'Galaxy Tab S4', 'Das Galaxy Tab S4 macht das Arbeiten unterwegs einfach. Genießen Sie viel Platz mit einem atemberaubenden, kristallklaren 10,5-Zoll-Bildschirm und verwandeln Sie Ihr Tablet, indem Sie das maßgeschneiderte Tastaturgehäuse anbringen. Für Jobs, die einen größeren Bildschirm benötigen, können Sie eine Verbindung zu einem Monitor herstellen und die Arbeit mit der chunkiest Tabellenkalkulation erledigen.', 'http://www.samsung.com/global/microsite/galaxytab2/',0);
INSERT INTO products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) VALUES (61, 3, 'Galaxy Tab S4', 'El Galaxy Tab S4 hace que trabajar sobre la marcha sea fácil. Disfrute de un montón de espacio con una impresionante pantalla de 10,5 pulgadas, cristalina, y transforme su tableta adjuntando la caja del teclado a medida. Para aquellos trabajos que necesitan una pantalla más grande, puede conectarse a un monitor y hacer que la hoja de cálculo más pesada funcione.', 'http://www.samsung.com/global/microsite/galaxytab2/',0);
INSERT INTO products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) VALUES (61, 4, 'Galaxy Tab S4', 'O Galaxy Tab S4 facilita o trabalho em movimento. Desfrute de muito espaço com uma tela impressionante de 10,5 polegadas e transforme seu tablet anexando o estojo de teclado sob medida. Para aqueles trabalhos que precisam de uma tela maior, você pode se conectar a um monitor e fazer um trabalho leve com a planilha mais chunky.', 'http://www.samsung.com/global/microsite/galaxytab2/',0);
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Batch Log file Directory', 'BATCH_LOG_FILE_DIRECTORY', 'C:/KonaKart/batchlogs/', 'The location where KonaKart will write batch log files', '20', '2', getdate());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Sitemap file Directory', 'SITEMAP_FILE_DIRECTORY', 'C:/KonaKart/batchlogs/', 'The location where KonaKart will write sitemap files', '30', '1', getdate());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Import files path','IMPORT_FILES_PATH','C:/KonaKart/data/','The import data files location',29,50,getdate());

-- Importer Log file location
DELETE FROM configuration WHERE configuration_key = 'IMPORTER_LOG_FILE_DIRECTORY';
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Importer Log file Directory', 'IMPORTER_LOG_FILE_DIRECTORY', 'C:/KonaKart/importerlogs/', 'The location where KonaKart will write importer log files', 29, 60, getdate());
...
INSERT INTO orders_status (orders_status_id, language_id, orders_status_name) VALUES (4,(SELECT languages_id FROM languages WHERE code = 'de'),'Warte auf Zahlung');
...
INSERT INTO orders_status (orders_status_id, language_id, orders_status_name) VALUES (4,(SELECT languages_id FROM languages WHERE code = 'pt'),'À espera de pagamento');
--5
...
INSERT INTO orders_status (orders_status_id, language_id, orders_status_name) VALUES (5,(SELECT languages_id FROM languages WHERE code = 'de'),'Zahlung empfangen');
...
INSERT INTO orders_status (orders_status_id, language_id, orders_status_name) VALUES (6,(SELECT languages_id FROM languages WHERE code = 'de'),'Zahlung nicht erfolgt');
...
INSERT INTO kk_content (content_id, content_type_id, click_url, search_key, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (16, 1, 'SelectProd.action?prodId={OBJ_ID}','TOP_BANNER_1', 34, 1, 1, 2, getdate(), getdate());
...
INSERT INTO kk_content (content_id, content_type_id, click_url, search_key, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (17, 1, 'SelectProd.action?prodId={OBJ_ID}','TOP_BANNER_2', 33, 1, 1, 2, getdate(), getdate());
...
INSERT INTO kk_content (content_id, content_type_id, click_url, search_key, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (18, 2, 'ShowSpecials.action','SUB_BANNER_1', 0, 0, 1, 2, getdate(), getdate());
...
INSERT INTO kk_content (content_id, content_type_id, click_url, search_key, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (19, 2, 'SelectCat.action?catId={OBJ_ID}','SUB_BANNER_2', 23, 2, 1, 2, getdate(), getdate());
...
INSERT INTO kk_content (content_id, content_type_id, click_url, search_key, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (20, 2, 'SelectCat.action?catId={OBJ_ID}','SUB_BANNER_3', 24, 2, 1, 2, getdate(), getdate());
...
INSERT INTO kk_content (content_id, content_type_id, click_url, search_key, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (21, 2, 'SelectProd.action?prodId={OBJ_ID}','SUB_BANNER_4', 32, 1, 1, 2, getdate(), getdate());
...
INSERT INTO kk_content (content_id, content_type_id, click_url, search_key, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (22, 2, 'SelectProd.action?prodId={OBJ_ID}','SUB_BANNER_5', 35, 1, 1, 2, getdate(), getdate());
...
INSERT INTO kk_content (content_id, content_type_id, click_url, search_key, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (23, 5, '','ABOUT_US', 0, 0, 1, 2, getdate(), getdate());
...
INSERT INTO kk_content (content_id, content_type_id, click_url, search_key, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (24, 6, '','SHIPPING_HANDLING', 0, 0, 1, 2, getdate(), getdate());
...
INSERT INTO kk_content (content_id, content_type_id, click_url, search_key, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (25, 7, '','RETURNS', 0, 0, 1, 2, getdate(), getdate());
...
INSERT INTO kk_content (content_id, content_type_id, click_url, search_key, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (26, 8, '','INTERNATIONAL_ORDERS', 0, 0, 1, 2, getdate(), getdate());
...
INSERT INTO kk_content (content_id, content_type_id, click_url, search_key, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (27, 9, '','PRIVACY', 0, 0, 1, 2, getdate(), getdate());
...
INSERT INTO kk_content (content_id, content_type_id, click_url, search_key, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (28, 10, '','TERMS_CONDITIONS', 0, 0, 1, 2, getdate(), getdate());
...
INSERT INTO kk_content (content_id, content_type_id, click_url, search_key, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (29, 11, '','HELP', 0, 0, 1, 2, getdate(), getdate());
...
INSERT INTO kk_content (content_id, content_type_id, click_url, search_key, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (30, 12, '','CONTACT', 0, 0, 1, 2, getdate(), getdate());
...
-- Logo Image
INSERT INTO kk_content (content_id, content_type_id, click_url, search_key, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (31, 13, 'Welcome.action','LOGO', -1, -1, 1, 2, getdate(), getdate());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, return_by_api) VALUES ('Add spelling suggestions for catalog','SOLR_ADD_SPELLING_FOR_CATALOG','false','Adds spelling suggestions for each catalog id since the catalog may contain only a subset of products','24', '170', 'choice(''true''=''true'',''false''=''false'')', getdate(), '1');

DELETE FROM configuration WHERE configuration_key = 'SOLR_CATALOG_USED_FOR_PRICE';
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, return_by_api) VALUES ('Catalogs used for product prices','SOLR_CATALOG_USED_FOR_PRICE','false','Set to true if catalogs are used to determine product prices','24', '180', 'choice(''true''=''true'',''false''=''false'')', getdate(), '0');

DELETE FROM configuration WHERE configuration_key = 'SOLR_CATALOG_USED_FOR_QTY';
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, return_by_api) VALUES ('Catalogs used for product quantities','SOLR_CATALOG_USED_FOR_QTY','false','Set to true if catalogs are used to determine product quantities','24', '190', 'choice(''true''=''true'',''false''=''false'')', getdate(), '0');
...
INSERT INTO orders_status (orders_status_id, language_id, orders_status_name) VALUES (11,(SELECT languages_id FROM languages WHERE code = 'de'),'Warten auf Bestätigung');
...
INSERT INTO orders_status (orders_status_id, language_id, orders_status_name) VALUES (13,(SELECT languages_id FROM languages WHERE code = 'de'),'Genehmigt Abgelehnt');
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, return_by_api, store_id) SELECT 'ERP Integration Enabled?', 'ERP_INT_INTEGRATION_ENABLED', 'false', 'Set to true to enable ERP Integration', '32', '5', 'choice(''true''=''true'',''false''=''false'')', getdate(), '1', store_id FROM configuration WHERE configuration_key = 'INSTALLATION_HOME';
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, return_by_api) VALUES ('Export Customer to ERP', 'ERP_EXPORT_CUSTOMER', 'true', 'When set to true KonaKart will export customer information (when a customer registers) to ERP', 32, 50, 'choice(''true''=''true'',''false''=''false'')', getdate(), '1');
DELETE FROM configuration where configuration_key = 'ERP_MATCH_CUSTOMER';
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, return_by_api) VALUES ('Send Match Customer message to ERP', 'ERP_MATCH_CUSTOMER', 'true', 'When set to true KonaKart will send a Match Customer message to ERP', 32, 60, 'choice(''true''=''true'',''false''=''false'')', getdate(), '1');
DELETE FROM configuration where configuration_key = 'ERP_EXPORT_ORDER';
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, return_by_api) VALUES ('Export Order to ERP', 'ERP_EXPORT_ORDER', 'true', 'When set to true KonaKart will export orders to ERP', 32, 70, 'choice(''true''=''true'',''false''=''false'')', getdate(), '1');
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, return_by_api) VALUES ('Example Parameter 2','USER_DEFINED_EXAMPLE_2','1,3,5','Example of a MultiSelect parameter','31', '15', 'multiselect(0=date.day.short.Sun,1=date.day.short.Mon,2=date.day.short.Tue,3=date.day.short.Wed,4=date.day.short.Thu,5=date.day.short.Fri,6=date.day.short.Sat)', getdate(), '1');
...
INSERT INTO kk_cust_attr (name, msg_cat_key, attr_type, template, validation, set_function, date_added) VALUES ('days-of-the-week', null, 0, null, null, 'multiselect(0=date.day.short.Sun,1=date.day.short.Mon,2=date.day.short.Tue,3=date.day.short.Wed,4=date.day.short.Thu,5=date.day.short.Fri,6=date.day.short.Sat)', getdate());

INSERT INTO kk_cust_attr_tmpl (name, description, date_added, store_id) VALUES ('Example Template', 'Just an example which can be deleted at any time', getdate(), 'store1');
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, return_by_api) VALUES ('Links to Store page in multi-vendor mode','MULTI_VENDOR_STORE_LINKS','true','Set to true to enable links to the store information page when in multi-vendor mode.','1', '36', 'choice(''true''=''true'',''false''=''false'')', getdate(), '1');

-- Configuration variable to set SMTP server port
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, return_by_api) VALUES  ('SMTP Port', 'SMTP_PORT', '25', 'SMTP Server Port', '12', '2', getdate(), '0');
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, return_by_api) VALUES ('Customer Update Notifications','ERP_CUSTOMER_NOTIFICATION','','Notifications when a customer registers or modifies his details or is deleted','32', '80', 'multiselect(1=label.insert,2=label.edit,3=label.delete)', getdate(), '1');

-- Control ERP Integration Order notifications
DELETE FROM configuration WHERE configuration_key = 'ERP_ORDER_NOTIFICATION';
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, return_by_api) VALUES ('Order Update Notifications','ERP_ORDER_NOTIFICATION','','Notifications when an order is inserted or the state is changed','32', '90', 'multiselect(1=label.insert,2=label.edit)', getdate(), '1');

-- Control ERP Integration Product notifications
DELETE FROM configuration WHERE configuration_key = 'ERP_PRODUCT_NOTIFICATION';
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, return_by_api) VALUES ('Product Update Notifications','ERP_PRODUCT_NOTIFICATION','','Notifications when a product is inserted, updated or deleted','32', '100', 'multiselect(1=label.insert,2=label.edit,3=label.delete)', getdate(), '1');

-- System Admin Email Address
DELETE FROM configuration WHERE configuration_key = 'SYSADMIN_EMAIL_ADDRESS';
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, return_by_api) VALUES ('Sys Admin Email','SYSADMIN_EMAIL_ADDRESS','admin@konakart.com','System Admin Email Address', '1', '5', getdate(), '0');

-- Notification of Storefront Exceptions
DELETE FROM configuration WHERE configuration_key = 'REPORT_STOREFRONT_EXCEPTIONS';
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, return_by_api) VALUES ('Storefront Exceptions','REPORT_STOREFRONT_EXCEPTIONS','true','Report Storefront Exceptions', '12', '20', 'choice(''true''=''true'',''false''=''false'')', getdate(), '1');

-- Notification of KKEng Exceptions
DELETE FROM configuration WHERE configuration_key = 'REPORT_KKENG_EXCEPTIONS';
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, return_by_api) VALUES ('KKEng Exceptions','REPORT_KKENG_EXCEPTIONS','true','Report KKEng Exceptions', '12', '25', 'choice(''true''=''true'',''false''=''false'')', getdate(), '1');

-- Notification of KKAdmin Exceptions
DELETE FROM configuration WHERE configuration_key = 'REPORT_KKADMIN_EXCEPTIONS';
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, return_by_api) VALUES ('KKAdmin Exceptions','REPORT_KKADMIN_EXCEPTIONS','true','Report KKAdmin Exceptions', '12', '30', 'choice(''true''=''true'',''false''=''false'')', getdate(), '1');
...
INSERT INTO kk_customer_tag (name, description, validation, tag_type, max_ints, date_added) VALUES ('FACEBOOK_LOGIN_ID', 'The Facebook id for a customer logging in using Facebook', '', 0, 1, getdate());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, return_by_api) VALUES ('Do not commit in code','SOLR_NO_COMMITS_IN_CODE','true','Do not send commits to SOLR in code','24', '60', 'choice(''true''=''true'',''false''=''false'')', getdate(), '1');

DELETE FROM configuration WHERE configuration_key = 'SOLR_DISTRIBUTED_TERMS_SEARCH';
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, return_by_api) VALUES ('Distributed terms searching','SOLR_DISTRIBUTED_TERMS_SEARCH','false','Add distrib=true parameter to searches for terms','24', '200', 'choice(''true''=''true'',''false''=''false'')', getdate(), '1');

DELETE FROM configuration WHERE configuration_key = 'SOLR_PATH';
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, return_by_api) VALUES ('SOLR path','SOLR_PATH','solr/konakart','SOLR path (typically this is solr/konakart)','24', '40', getdate(), '0');

DELETE FROM configuration WHERE configuration_key = 'ZOOKEEPER_HOSTS';
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, return_by_api) VALUES ('Zookeeper Hosts','ZOOKEEPER_HOSTS','127.0.0.1:2181,127.0.0.1:2182,127.0.0.1:2183','Addresses of one or more Zookeeper hosts used to look up live SOLR locations','24', '50', getdate(), '0');

DELETE FROM configuration WHERE configuration_key = 'SOLR_ACCESS_MODE';
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, return_by_api) VALUES ('SOLR Access Mode','SOLR_ACCESS_MODE','Solr','Do not send commits to SOLR in code','24', '20', 'option(Solr=dl.solr.access.mode.solr.url,Zookeeper=dl.solr.access.mode.zookeeper,Custom=dl.solr.access.mode.custom)', getdate(), '0');
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, return_by_api) VALUES ('Enable Newsletter Double Opt-In','ENABLE_NEWSLETTER_DOUBLE_OPT_IN','false','When true, a customer receives an eMail with a link to click on to confirm newsletter subscription',1, 65, 'choice(''true''=''true'',''false''=''false'')', getdate(), '1');
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, return_by_api) VALUES ('Default Catalog Key','DEFAULT_CATALOG_KEY','','Default catalog key to use if the customer does not have one assigned in a customer tag value',1,70,getdate(),'1');

-- New API calls
INSERT INTO kk_api_call (name, description, date_added) VALUES ('removeMallStore', '', getdate());

-- Add custom_attrs to the orders_products table
ALTER TABLE orders_products ADD custom_attrs NVARCHAR(MAX);

-- Increase length of configuration variables
ALTER TABLE configuration ALTER COLUMN configuration_value NVARCHAR(2048);

-- New Admin App Panel for configuration of integrations
INSERT INTO kk_panel (code, description, date_added) VALUES ('kk_panel_integrations','ERP Integration Configuration', getdate());

-- Add Integrations Config Panel access to all roles that can access the 'kk_panel_storeConfiguration' panel
INSERT INTO kk_role_to_panel (role_id, panel_id, can_edit, can_insert, can_delete, date_added, store_id) SELECT role_id, p2.panel_id, 1, 1, 1, getdate(), store_id FROM kk_role_to_panel rtp, kk_panel p, kk_panel p2 where rtp.panel_id=p.panel_id and p.code='kk_panel_storeConfiguration' and p2.code='kk_panel_integrations';
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, return_by_api) VALUES ('Integrated Products','INTEGRATED_PRODUCTS','','Used to store a comma separated list of integrated products',33,10,getdate(),'1');
...
ALTER TABLE kk_customers_to_tag ALTER COLUMN tag_value NVARCHAR(1024);

DELETE FROM kk_customer_tag WHERE name ='PRODUCTS_TIME_VIEWED';
INSERT INTO kk_customer_tag (name, description, validation, tag_type, max_ints, set_by_api, date_added) VALUES ('PRODUCTS_TIME_VIEWED', 'Recently viewed product id', '((:[0-9]+ [0-9]+)+:|)', 7, 10, 1, getdate());
DELETE FROM kk_customer_tag WHERE name ='CATEGORIES_TIME_VIEWED';
INSERT INTO kk_customer_tag (name, description, validation, tag_type, max_ints, set_by_api, date_added) VALUES ('CATEGORIES_TIME_VIEWED', 'Recently viewed category id', '((:[0-9]+ [0-9]+)+:|)', 7, 10, 1, getdate());
DELETE FROM kk_customer_tag WHERE name ='MANUFACTURERS_TIME_VIEWED';
INSERT INTO kk_customer_tag (name, description, validation, tag_type, max_ints, set_by_api, date_added) VALUES ('MANUFACTURERS_TIME_VIEWED', 'Recently viewed manufacturer id', '((:[0-9]+ [0-9]+)+:|)', 7, 10, 1, getdate());
DELETE FROM kk_customer_tag WHERE name ='PRODUCTS_TIME_IN_CART';
INSERT INTO kk_customer_tag (name, description, validation, tag_type, max_ints, set_by_api, date_added) VALUES ('PRODUCTS_TIME_IN_CART', 'Id of a product in the cart', '((:[0-9]+ [0-9]+)+:|)', 7, 10, 1, getdate());
DELETE FROM kk_customer_tag WHERE name ='PRODUCTS_TIME_IN_WISHLIST';
INSERT INTO kk_customer_tag (name, description, validation, tag_type, max_ints, set_by_api, date_added) VALUES ('PRODUCTS_TIME_IN_WISHLIST', 'Id of a product in the Wish List', '((:[0-9]+ [0-9]+)+:|)', 7, 10, 1, getdate());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, return_by_api) VALUES ('URL for AI Service','ARTIFICIAL_INTELLIGENCE_URL','http://to-be-confirmed/','URL for Artificial Intelligence Service',34,10,getdate(),'0');
DELETE FROM configuration WHERE configuration_key = 'ARTIFICIAL_INTELLIGENCE_CONNECT_TIMEOUT';
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, return_by_api) VALUES ('Connection timeout for AI Service','ARTIFICIAL_INTELLIGENCE_CONNECT_TIMEOUT','20000','Connection timeout for Artificial Intelligence Service in milliseconds',34,20,getdate(),'0');
DELETE FROM configuration WHERE configuration_key = 'ARTIFICIAL_INTELLIGENCE_READ_TIMEOUT';
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, return_by_api) VALUES ('Read timeout for AI Service','ARTIFICIAL_INTELLIGENCE_READ_TIMEOUT','30000','Read timeout for Artificial Intelligence Service in milliseconds',34,30,getdate(),'0');
DELETE FROM configuration WHERE configuration_key = 'ARTIFICIAL_INTELLIGENCE_USERNAME';
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, return_by_api) VALUES ('AI Service Username','ARTIFICIAL_INTELLIGENCE_USERNAME','','Artificial Intelligence Service Username',34,40,getdate(),'0');
DELETE FROM configuration WHERE configuration_key = 'ARTIFICIAL_INTELLIGENCE_PASSWORD';
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, return_by_api, set_function) VALUES ('AI Service Password','ARTIFICIAL_INTELLIGENCE_PASSWORD','','Artificial Intelligence Service Password',34,50,getdate(),'0','password');
DELETE FROM configuration WHERE configuration_key = 'ARTIFICIAL_INTELLIGENCE_VERSION';
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, return_by_api) VALUES ('AI Data Current Version','ARTIFICIAL_INTELLIGENCE_VERSION','1','Current version of the Artificial Intelligence data',34,60,getdate(),'1');
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Warn of Duplicate Coupons', 'ADMIN_APP_WARN_OF_DUPLICATE_COUPONS', 'true', 'Issue warning in Admin App of duplicate coupon codes', '21', '32', 'choice(''true''=''true'',''false''=''false'')', getdate());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, return_by_api) VALUES ('Example Parameter 3','USER_DEFINED_EXAMPLE_3','2 to 40 characters only','Example of a config variable with a string setFun','31', '20', 'string(2,40)', getdate(), '1');

-- Add index on SKU
CREATE INDEX i_products_sku_products ON products (products_sku);
CREATE INDEX i_products_sku_products_quantity ON products_quantity (products_sku);

-- Used in storefront to set a startup catalog id
DELETE FROM configuration WHERE configuration_key = 'STARTUP_CATALOG_KEY';
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, return_by_api) VALUES ('Startup Catalog Key','STARTUP_CATALOG_KEY','','Default catalog key used at startup',1,80,getdate(),'1');
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, return_by_api) VALUES ('Maintain CRC Cache','MAINTAIN_CRC_IMAGE_CACHE','Maintain a product image cache','Maintain a cache of images that contain the CRC value in the filename - only for WOND systems','4', '25', 'choice(''true''=''true'',''false''=''false'')', getdate(), '1');
...
CREATE TABLE kk_catalog (
  ...
  store_id VARCHAR(64),
  cat_name NVARCHAR(64) NOT NULL,
  description NVARCHAR(255),
  use_cat_prices INT,
  use_cat_quantities INT,
  cat_name_for VARCHAR(64),
  catalog_type INT DEFAULT 0 NOT NULL,
  date_active DATETIME,
  last_creation_date DATETIME,
  PRIMARY KEY(catalog_id)
);
CREATE INDEX i_kcg_name ON kk_catalog (cat_name);
CREATE INDEX i_kcg_namefor ON kk_catalog (cat_name_for);
CREATE INDEX i_kcg_active ON kk_catalog (date_active);
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, return_by_api) VALUES ('Future Catalog Date Format','CATALOG_FUTURE_DATE_FORMAT','dd/MM/yyyy HH:mm','Future Catalog Date Format',1,100,getdate(),'1');
...
INSERT INTO kk_customer_tag (name, description, validation, tag_type, max_ints, date_added) VALUES ('FAVOURITE_CITY', 'Favourite City of the Customer', '', 0, 1, getdate());
DELETE FROM kk_customer_tag WHERE name ='FAVOURITE_COLOUR';
INSERT INTO kk_customer_tag (name, description, validation, tag_type, max_ints, date_added) VALUES ('FAVOURITE_COLOUR', 'Favourite Colour of the Customer', '', 0, 1, getdate());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, return_by_api) VALUES ('Status Ids of completed orders','COMPLETED_ORDER_STATUS_IDS','3,5','Comma separated list of Completed Order Status Ids (used in Order Statistics batch jobs)',9,60,getdate(),'1');

-- French Zones (Metropolitan Departments from ISO-3166:FR)
INSERT INTO zones (zone_country_id, zone_code, zone_name, custom1) VALUES (73,'FR-01','Ain','FR-ARA');
INSERT INTO zones (zone_country_id, zone_code, zone_name, custom1) VALUES (73,'FR-02','Aisne','FR-HDF');
INSERT INTO zones (zone_country_id, zone_code, zone_name, custom1) VALUES (73,'FR-03','Allier','FR-ARA');
INSERT INTO zones (zone_country_id, zone_code, zone_name, custom1) VALUES (73,'FR-06','Alpes-Maritimes','FR-PAC');
INSERT INTO zones (zone_country_id, zone_code, zone_name, custom1) VALUES (73,'FR-04','Alpes-de-Haute-Provence','FR-PAC');
INSERT INTO zones (zone_country_id, zone_code, zone_name, custom1) VALUES (73,'FR-08','Ardennes','FR-GES');
INSERT INTO zones (zone_country_id, zone_code, zone_name, custom1) VALUES (73,'FR-07','Ardèche','FR-ARA');
INSERT INTO zones (zone_country_id, zone_code, zone_name, custom1) VALUES (73,'FR-09','Ariège','FR-OCC');
INSERT INTO zones (zone_country_id, zone_code, zone_name, custom1) VALUES (73,'FR-10','Aube','FR-GES');
INSERT INTO zones (zone_country_id, zone_code, zone_name, custom1) VALUES (73,'FR-11','Aude','FR-OCC');
INSERT INTO zones (zone_country_id, zone_code, zone_name, custom1) VALUES (73,'FR-12','Aveyron','FR-OCC');
INSERT INTO zones (zone_country_id, zone_code, zone_name, custom1) VALUES (73,'FR-67','Bas-Rhin','FR-GES');
INSERT INTO zones (zone_country_id, zone_code, zone_name, custom1) VALUES (73,'FR-13','Bouches-du-Rhône','FR-PAC');
INSERT INTO zones (zone_country_id, zone_code, zone_name, custom1) VALUES (73,'FR-14','Calvados','FR-NOR');
INSERT INTO zones (zone_country_id, zone_code, zone_name, custom1) VALUES (73,'FR-15','Cantal','FR-ARA');
INSERT INTO zones (zone_country_id, zone_code, zone_name, custom1) VALUES (73,'FR-16','Charente','FR-NAQ');
INSERT INTO zones (zone_country_id, zone_code, zone_name, custom1) VALUES (73,'FR-17','Charente-Maritime','FR-NAQ');
INSERT INTO zones (zone_country_id, zone_code, zone_name, custom1) VALUES (73,'FR-18','Cher','FR-CVL');
INSERT INTO zones (zone_country_id, zone_code, zone_name, custom1) VALUES (73,'FR-19','Corrèze','FR-NAQ');
INSERT INTO zones (zone_country_id, zone_code, zone_name, custom1) VALUES (73,'FR-2A','Corse-du-Sud','FR-COR');
INSERT INTO zones (zone_country_id, zone_code, zone_name, custom1) VALUES (73,'FR-23','Creuse','FR-NAQ');
INSERT INTO zones (zone_country_id, zone_code, zone_name, custom1) VALUES (73,'FR-21','Côte-d''Or','FR-BFC');
INSERT INTO zones (zone_country_id, zone_code, zone_name, custom1) VALUES (73,'FR-22','Côtes-d''Armor','FR-BRE');
INSERT INTO zones (zone_country_id, zone_code, zone_name, custom1) VALUES (73,'FR-79','Deux-Sèvres','FR-NAQ');
INSERT INTO zones (zone_country_id, zone_code, zone_name, custom1) VALUES (73,'FR-24','Dordogne','FR-NAQ');
INSERT INTO zones (zone_country_id, zone_code, zone_name, custom1) VALUES (73,'FR-25','Doubs','FR-BFC');
INSERT INTO zones (zone_country_id, zone_code, zone_name, custom1) VALUES (73,'FR-26','Drôme','FR-ARA');
INSERT INTO zones (zone_country_id, zone_code, zone_name, custom1) VALUES (73,'FR-91','Essonne','FR-IDF');
INSERT INTO zones (zone_country_id, zone_code, zone_name, custom1) VALUES (73,'FR-27','Eure','FR-NOR');
INSERT INTO zones (zone_country_id, zone_code, zone_name, custom1) VALUES (73,'FR-28','Eure-et-Loir','FR-CVL');
INSERT INTO zones (zone_country_id, zone_code, zone_name, custom1) VALUES (73,'FR-29','Finistère','FR-BRE');
INSERT INTO zones (zone_country_id, zone_code, zone_name, custom1) VALUES (73,'FR-30','Gard','FR-OCC');
INSERT INTO zones (zone_country_id, zone_code, zone_name, custom1) VALUES (73,'FR-32','Gers','FR-OCC');
INSERT INTO zones (zone_country_id, zone_code, zone_name, custom1) VALUES (73,'FR-33','Gironde','FR-NAQ');
INSERT INTO zones (zone_country_id, zone_code, zone_name, custom1) VALUES (73,'FR-68','Haut-Rhin','FR-GES');
INSERT INTO zones (zone_country_id, zone_code, zone_name, custom1) VALUES (73,'FR-2B','Haute-Corse','FR-COR');
INSERT INTO zones (zone_country_id, zone_code, zone_name, custom1) VALUES (73,'FR-31','Haute-Garonne','FR-OCC');
INSERT INTO zones (zone_country_id, zone_code, zone_name, custom1) VALUES (73,'FR-43','Haute-Loire','FR-ARA');
INSERT INTO zones (zone_country_id, zone_code, zone_name, custom1) VALUES (73,'FR-52','Haute-Marne','FR-GES');
INSERT INTO zones (zone_country_id, zone_code, zone_name, custom1) VALUES (73,'FR-74','Haute-Savoie','FR-ARA');
INSERT INTO zones (zone_country_id, zone_code, zone_name, custom1) VALUES (73,'FR-70','Haute-Saône','FR-BFC');
INSERT INTO zones (zone_country_id, zone_code, zone_name, custom1) VALUES (73,'FR-87','Haute-Vienne','FR-NAQ');
INSERT INTO zones (zone_country_id, zone_code, zone_name, custom1) VALUES (73,'FR-05','Hautes-Alpes','FR-PAC');
INSERT INTO zones (zone_country_id, zone_code, zone_name, custom1) VALUES (73,'FR-65','Hautes-Pyrénées','FR-OCC');
INSERT INTO zones (zone_country_id, zone_code, zone_name, custom1) VALUES (73,'FR-92','Hauts-de-Seine','FR-IDF');
INSERT INTO zones (zone_country_id, zone_code, zone_name, custom1) VALUES (73,'FR-34','Hérault','FR-OCC');
INSERT INTO zones (zone_country_id, zone_code, zone_name, custom1) VALUES (73,'FR-35','Ille-et-Vilaine','FR-BRE');
INSERT INTO zones (zone_country_id, zone_code, zone_name, custom1) VALUES (73,'FR-36','Indre','FR-CVL');
INSERT INTO zones (zone_country_id, zone_code, zone_name, custom1) VALUES (73,'FR-37','Indre-et-Loire','FR-CVL');
INSERT INTO zones (zone_country_id, zone_code, zone_name, custom1) VALUES (73,'FR-38','Isère','FR-ARA');
INSERT INTO zones (zone_country_id, zone_code, zone_name, custom1) VALUES (73,'FR-39','Jura','FR-BFC');
INSERT INTO zones (zone_country_id, zone_code, zone_name, custom1) VALUES (73,'FR-40','Landes','FR-NAQ');
INSERT INTO zones (zone_country_id, zone_code, zone_name, custom1) VALUES (73,'FR-41','Loir-et-Cher','FR-CVL');
INSERT INTO zones (zone_country_id, zone_code, zone_name, custom1) VALUES (73,'FR-42','Loire','FR-ARA');
INSERT INTO zones (zone_country_id, zone_code, zone_name, custom1) VALUES (73,'FR-44','Loire-Atlantique','FR-PDL');
INSERT INTO zones (zone_country_id, zone_code, zone_name, custom1) VALUES (73,'FR-45','Loiret','FR-CVL');
INSERT INTO zones (zone_country_id, zone_code, zone_name, custom1) VALUES (73,'FR-46','Lot','FR-OCC');
INSERT INTO zones (zone_country_id, zone_code, zone_name, custom1) VALUES (73,'FR-47','Lot-et-Garonne','FR-NAQ');
INSERT INTO zones (zone_country_id, zone_code, zone_name, custom1) VALUES (73,'FR-48','Lozère','FR-OCC');
INSERT INTO zones (zone_country_id, zone_code, zone_name, custom1) VALUES (73,'FR-49','Maine-et-Loire','FR-PDL');
INSERT INTO zones (zone_country_id, zone_code, zone_name, custom1) VALUES (73,'FR-50','Manche','FR-NOR');
INSERT INTO zones (zone_country_id, zone_code, zone_name, custom1) VALUES (73,'FR-51','Marne','FR-GES');
INSERT INTO zones (zone_country_id, zone_code, zone_name, custom1) VALUES (73,'FR-53','Mayenne','FR-PDL');
INSERT INTO zones (zone_country_id, zone_code, zone_name, custom1) VALUES (73,'FR-54','Meurthe-et-Moselle','FR-GES');
INSERT INTO zones (zone_country_id, zone_code, zone_name, custom1) VALUES (73,'FR-55','Meuse','FR-GES');
INSERT INTO zones (zone_country_id, zone_code, zone_name, custom1) VALUES (73,'FR-56','Morbihan','FR-BRE');
INSERT INTO zones (zone_country_id, zone_code, zone_name, custom1) VALUES (73,'FR-57','Moselle','FR-GES');
INSERT INTO zones (zone_country_id, zone_code, zone_name, custom1) VALUES (73,'FR-58','Nièvre','FR-BFC');
INSERT INTO zones (zone_country_id, zone_code, zone_name, custom1) VALUES (73,'FR-59','Nord','FR-HDF');
INSERT INTO zones (zone_country_id, zone_code, zone_name, custom1) VALUES (73,'FR-60','Oise','FR-HDF');
INSERT INTO zones (zone_country_id, zone_code, zone_name, custom1) VALUES (73,'FR-61','Orne','FR-NOR');
INSERT INTO zones (zone_country_id, zone_code, zone_name, custom1) VALUES (73,'FR-75','Paris','FR-IDF');
INSERT INTO zones (zone_country_id, zone_code, zone_name, custom1) VALUES (73,'FR-62','Pas-de-Calais','FR-HDF');
INSERT INTO zones (zone_country_id, zone_code, zone_name, custom1) VALUES (73,'FR-63','Puy-de-Dôme','FR-ARA');
INSERT INTO zones (zone_country_id, zone_code, zone_name, custom1) VALUES (73,'FR-64','Pyrénées-Atlantiques','FR-NAQ');
INSERT INTO zones (zone_country_id, zone_code, zone_name, custom1) VALUES (73,'FR-66','Pyrénées-Orientales','FR-OCC');
INSERT INTO zones (zone_country_id, zone_code, zone_name, custom1) VALUES (73,'FR-69','Rhône','FR-ARA');
INSERT INTO zones (zone_country_id, zone_code, zone_name, custom1) VALUES (73,'FR-72','Sarthe','FR-PDL');
INSERT INTO zones (zone_country_id, zone_code, zone_name, custom1) VALUES (73,'FR-73','Savoie','FR-ARA');
INSERT INTO zones (zone_country_id, zone_code, zone_name, custom1) VALUES (73,'FR-71','Saône-et-Loire','FR-BFC');
INSERT INTO zones (zone_country_id, zone_code, zone_name, custom1) VALUES (73,'FR-76','Seine-Maritime','FR-NOR');
INSERT INTO zones (zone_country_id, zone_code, zone_name, custom1) VALUES (73,'FR-93','Seine-Saint-Denis','FR-IDF');
INSERT INTO zones (zone_country_id, zone_code, zone_name, custom1) VALUES (73,'FR-77','Seine-et-Marne','FR-IDF');
INSERT INTO zones (zone_country_id, zone_code, zone_name, custom1) VALUES (73,'FR-80','Somme','FR-HDF');
INSERT INTO zones (zone_country_id, zone_code, zone_name, custom1) VALUES (73,'FR-81','Tarn','FR-OCC');
INSERT INTO zones (zone_country_id, zone_code, zone_name, custom1) VALUES (73,'FR-82','Tarn-et-Garonne','FR-OCC');
INSERT INTO zones (zone_country_id, zone_code, zone_name, custom1) VALUES (73,'FR-90','Territoire de Belfort','FR-BFC');
INSERT INTO zones (zone_country_id, zone_code, zone_name, custom1) VALUES (73,'FR-95','Val-d''Oise','FR-IDF');
INSERT INTO zones (zone_country_id, zone_code, zone_name, custom1) VALUES (73,'FR-94','Val-de-Marne','FR-IDF');
INSERT INTO zones (zone_country_id, zone_code, zone_name, custom1) VALUES (73,'FR-83','Var','FR-PAC');
INSERT INTO zones (zone_country_id, zone_code, zone_name, custom1) VALUES (73,'FR-84','Vaucluse','FR-PAC');
INSERT INTO zones (zone_country_id, zone_code, zone_name, custom1) VALUES (73,'FR-85','Vendée','FR-PDL');
INSERT INTO zones (zone_country_id, zone_code, zone_name, custom1) VALUES (73,'FR-86','Vienne','FR-NAQ');
INSERT INTO zones (zone_country_id, zone_code, zone_name, custom1) VALUES (73,'FR-88','Vosges','FR-GES');
INSERT INTO zones (zone_country_id, zone_code, zone_name, custom1) VALUES (73,'FR-89','Yonne','FR-BFC');
INSERT INTO zones (zone_country_id, zone_code, zone_name, custom1) VALUES (73,'FR-78','Yvelines','FR-IDF');

-- Add CHF

INSERT INTO currencies ( title, code, symbol_left, symbol_right, decimal_point, thousands_point, decimal_places, value, last_updated) VALUES ('CHF','CHF','CHF ','','.',',','2','1.0000', getdate());

-- New order state - Paid-Not Processed
INSERT INTO orders_status (orders_status_id, language_id, orders_status_name) VALUES (15,(SELECT languages_id FROM languages WHERE code = 'en'),'Paid-Not processed');
INSERT INTO orders_status (orders_status_id, language_id, orders_status_name) VALUES (15,(SELECT languages_id FROM languages WHERE code = 'de'),'Bezahlt-Nicht bearbeitet');
INSERT INTO orders_status (orders_status_id, language_id, orders_status_name) VALUES (15,(SELECT languages_id FROM languages WHERE code = 'es'),'Pagado-No procesado');
INSERT INTO orders_status (orders_status_id, language_id, orders_status_name) VALUES (15,(SELECT languages_id FROM languages WHERE code = 'pt'),'Pago-Não processado');
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order,set_function, date_added, return_by_api) VALUES ('Content for specifications tab','CONFIG_CONTENT_FOR_SPECS_TAB','CONTENT_CUSTOM_ATTRS','Content to display in specifications tab of product detail panel',1,110,'option(CONTENT_CUSTOM_ATTRS=label.custom.attrs,CONTENT_COMPARISON_DATA=label.productComparison)',getdate(),'1');
...
-- New API Call
INSERT INTO kk_api_call (name, description, date_added) VALUES ('removeRelatedProduct', '', getdate());


-----------------  v9.4.0.0

-- Set database version information
INSERT INTO kk_config (kk_config_key, kk_config_value, date_added) VALUES ('HISTORY', '9.4.0.0 I', getdate());
INSERT INTO kk_config (kk_config_key, kk_config_value, date_added) VALUES ('VERSION', '9.4.0.0 SQLServer', getdate());
...
ALTER TABLE kk_booking ADD last_modified datetime;

-- New API Calls
INSERT INTO kk_api_call (name, description, date_added) VALUES ('deleteReviewsPerCustomer', '', getdate());
INSERT INTO kk_api_call (name, description, date_added) VALUES ('deleteVendorReviewsPerCustomer', '', getdate());

-- Table for order return status
DROP TABLE kk_order_return_status;
CREATE TABLE kk_order_return_status (
  returns_status_pk int NOT NULL identity(1,1),
  store_id varchar(64),
  returns_status_id int DEFAULT 0 NOT NULL,
  language_id int DEFAULT 1 NOT NULL,
...
-- New API Calls
INSERT INTO kk_api_call (name, description, date_added) VALUES ('getOrderReturnStatuses', '', getdate());
INSERT INTO kk_api_call (name, description, date_added) VALUES ('deleteOrderReturnStatus', '', getdate());
INSERT INTO kk_api_call (name, description, date_added) VALUES ('insertOrderReturnStatus', '', getdate());
INSERT INTO kk_api_call (name, description, date_added) VALUES ('insertOrderReturnStatuses', '', getdate());
INSERT INTO kk_api_call (name, description, date_added) VALUES ('updateOrderReturnStatus', '', getdate());
INSERT INTO kk_api_call (name, description, date_added) VALUES ('getAllOrderReturnStatuses', '', getdate());

-- Add some default order return statuses
INSERT INTO kk_order_return_status (returns_status_id, language_id, returns_status_name) VALUES (0,1,'Undefined');
INSERT INTO kk_order_return_status (returns_status_id, language_id, returns_status_name) VALUES (0,2,'Undefiniert');
INSERT INTO kk_order_return_status (returns_status_id, language_id, returns_status_name) VALUES (0,3,'Indefinido');
INSERT INTO kk_order_return_status (returns_status_id, language_id, returns_status_name) VALUES (0,4,'Indefinido');

INSERT INTO kk_order_return_status (returns_status_id, language_id, returns_status_name) VALUES (1,1,'Requested');
INSERT INTO kk_order_return_status (returns_status_id, language_id, returns_status_name) VALUES (1,2,'Erwünscht');
INSERT INTO kk_order_return_status (returns_status_id, language_id, returns_status_name) VALUES (1,3,'Solicitado');
INSERT INTO kk_order_return_status (returns_status_id, language_id, returns_status_name) VALUES (1,4,'Solicitada');

INSERT INTO kk_order_return_status (returns_status_id, language_id, returns_status_name) VALUES (2,1,'Approved');
INSERT INTO kk_order_return_status (returns_status_id, language_id, returns_status_name) VALUES (2,2,'Genehmigt');
INSERT INTO kk_order_return_status (returns_status_id, language_id, returns_status_name) VALUES (2,3,'Aprobado');
INSERT INTO kk_order_return_status (returns_status_id, language_id, returns_status_name) VALUES (2,4,'Aprovado');

INSERT INTO kk_order_return_status (returns_status_id, language_id, returns_status_name) VALUES (3,1,'Rejected');
INSERT INTO kk_order_return_status (returns_status_id, language_id, returns_status_name) VALUES (3,2,'Abgelehnt');
INSERT INTO kk_order_return_status (returns_status_id, language_id, returns_status_name) VALUES (3,3,'Rechazado');
INSERT INTO kk_order_return_status (returns_status_id, language_id, returns_status_name) VALUES (3,4,'Rejeitado');

INSERT INTO kk_order_return_status (returns_status_id, language_id, returns_status_name) VALUES (4,1,'Received');
INSERT INTO kk_order_return_status (returns_status_id, language_id, returns_status_name) VALUES (4,2,'Empfangen');
INSERT INTO kk_order_return_status (returns_status_id, language_id, returns_status_name) VALUES (4,3,'Recibido');
INSERT INTO kk_order_return_status (returns_status_id, language_id, returns_status_name) VALUES (4,4,'Recebido');

-- Order Return statuses panel
-- New Admin App Panel for configuration of Order Return Statuses
INSERT INTO kk_panel (code, description, date_added) VALUES ('kk_panel_orderReturnStatuses','Order Return Statuses', getdate());

-- Give Order Return statuses panel access to all roles that can access the 'kk_panel_orderStatuses' panel
INSERT INTO kk_role_to_panel (role_id, panel_id, can_edit, can_insert, can_delete, date_added, store_id) SELECT role_id, p2.panel_id, 1, 1, 1, getdate(), store_id FROM kk_role_to_panel rtp, kk_panel p, kk_panel p2 where rtp.panel_id=p.panel_id and p.code='kk_panel_orderStatuses' and p2.code='kk_panel_orderReturnStatuses';
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order,date_added, return_by_api) VALUES ('Output Queue Prefix','ERP_OUTPUT_QUEUE_PREFIX','KonaKart.','Output queue name for ERP integration is this prefix + storeId + .Q',32,110,getdate(),'1');

-- New configuration variable to allow setting of STARTTLS for emails
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, set_function) VALUES ('SMTP StartTLS','SMTP_STARTTLS','false','Whether or not to enable STARTTLS', '12', '3', getdate(), 'choice(''true''=''true'',''false''=''false'')');
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order,date_added, return_by_api) VALUES ('System ID','SYSTEM_ID','','Can be used for any custom purpose to identify the system',32,120,getdate(),'1');
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, set_function) VALUES ('New OT for each tax rate?','MODULE_ORDER_TOTAL_TAX_MULTIPLE_LINES','false','Do you want to have multiple order totals for different tax rates? Tax code must be set on tax class', '6', '3', getdate(), 'choice(''true''=''true'',''false''=''false'')');
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Run Initial Product Search', 'PROD_PANEL_RUN_INITIAL_SEARCH', 'true', 'Set to true to always run the initial Product Search', 21, 13, 'choice(''true''=''true'',''false''=''false'')', getdate());

-- For specifying whether or not customer tags are intended to be used in expressions
ALTER TABLE kk_customer_tag ADD used_in_expressions smallint DEFAULT 1 NOT NULL;
...
-- New KKAdminIf API
INSERT INTO kk_api_call (name, description, date_added) VALUES ('deleteCatalogWithOptions', '', getdate());
