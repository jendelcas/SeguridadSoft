#----------------------------------------------------------------
# KonaKart upgrade script from version 9.2.0.0 to version 9.4.0.0
#----------------------------------------------------------------
#
...
UPDATE kk_config SET kk_config_value='9.4.0.0 MySQL', date_added=now() WHERE kk_config_key='VERSION';
