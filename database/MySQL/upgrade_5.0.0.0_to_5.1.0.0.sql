...
#DB2 UPDATE configuration set configuration_value = 'C:/KonaKart/database/DB2/konakart_new_store_cs.sql' where configuration_key = 'KK_NEW_STORE_SQL_FILENAME' and configuration_value = 'C:/KonaKart/database/MySQL/konakart_new_store_cs.sql';
#MSSSQL UPDATE configuration set configuration_value = 'C:/KonaKart/database/MSSqlServer/konakart_new_store_cs.sql' where configuration_key = 'KK_NEW_STORE_SQL_FILENAME' and configuration_value = 'C:/KonaKart/database/MySQL/konakart_new_store_cs.sql';
#Oracle UPDATE configuration set configuration_value = 'C:/KonaKart/database/Oracle/konakart_new_store_cs.sql' where configuration_key = 'KK_NEW_STORE_SQL_FILENAME' and configuration_value = 'C:/KonaKart/database/MySQL/konakart_new_store_cs.sql';
#PostgreSQL UPDATE configuration set configuration_value = 'C:/KonaKart/database/PostgreSQL/konakart_new_store_cs.sql' where configuration_key = 'KK_NEW_STORE_SQL_FILENAME' and configuration_value = 'C:/KonaKart/database/MySQL/konakart_new_store_cs.sql';
