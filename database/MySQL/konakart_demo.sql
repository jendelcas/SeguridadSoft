#----------------------------------------------------------
# KonaKart v9.4.0.2 demo database script for MySQL database
#----------------------------------------------------------
#
# Note: 
# This script is derived from the initialisation script from the osCommerce 
# eCommerce system (http://www.oscommerce.com) and so retains the
# osCommerce copyright.  
# KonaKart uses many additional tables and several changes to the
# osCommerce original which are released with a DS Data Systems UK Ltd. copyright.
#
...
INSERT INTO currencies VALUES (2,'Euro','EUR','','EUR','.',',','2','1.1000', now());
...
ALTER TABLE products_description MODIFY products_name VARCHAR(150);
...
ALTER TABLE categories_description MODIFY categories_name VARCHAR(150);

#---------------  v5.8.0.0

# Extend the size of the products_name field 
ALTER TABLE orders_products MODIFY products_name VARCHAR(150);
...
INSERT INTO products (products_id, products_model, products_price, products_weight, products_status, products_tax_class_id, manufacturers_id, products_quantity, products_ordered, products_date_added, products_date_available) VALUES (32, 'WIN10', 129.99, 6, 1, 1, 2, 100, 0, now(), now());
...
INSERT INTO products (products_id, products_model, products_price, products_weight, products_status, products_tax_class_id, manufacturers_id, products_quantity, products_ordered, products_date_added, products_date_available) VALUES (47, 'IPHONEXS', 999.99, 3, 1, 1, 14, 100, 0, now(), now());
...
INSERT INTO products (products_id, products_model, products_price, products_weight, products_status, products_tax_class_id, manufacturers_id, products_quantity, products_ordered, products_date_added, products_date_available) VALUES (50, 'WB1100F', 155.99, 1, 1, 1, 21, 100, 0, now(), now());
...
INSERT INTO products (products_id, products_model, products_price, products_weight, products_status, products_tax_class_id, manufacturers_id, products_quantity, products_ordered, products_date_added, products_date_available) VALUES (61, 'GALTABS4', 699.99, 2, 1, 1, 21, 100, 0, now(), now());
...
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (14,4,(SELECT languages_id FROM languages WHERE code = 'de'),'Warte auf Zahlung');
...
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (16,4,(SELECT languages_id FROM languages WHERE code = 'pt'),'À espera de pagamento');
#5
...
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (18,5,(SELECT languages_id FROM languages WHERE code = 'de'),'Zahlung empfangen');
...
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (22,6,(SELECT languages_id FROM languages WHERE code = 'de'),'Zahlung nicht erfolgt');
...
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (42,11,(SELECT languages_id FROM languages WHERE code = 'de'),'Warten auf Bestätigung');
...
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (50,13,(SELECT languages_id FROM languages WHERE code = 'de'),'Genehmigt Abgelehnt');
...
INSERT INTO kk_cust_attr (name, msg_cat_key, attr_type, template, validation, set_function, date_added) VALUES ('days-of-the-week', null, 0, null, null, 'multiselect(0=date.day.short.Sun,1=date.day.short.Mon,2=date.day.short.Tue,3=date.day.short.Wed,4=date.day.short.Thu,5=date.day.short.Fri,6=date.day.short.Sat)', now());
...
# Add index on SKU
ALTER TABLE products ADD KEY idx_sku (products_sku);
ALTER TABLE products_quantity ADD KEY idx_pq_sku (products_sku);
...
CREATE TABLE kk_catalog (
   ...
   KEY i_kcg_name (cat_name),
   KEY i_kcg_namefor (cat_name_for),
   KEY i_kcg_active (date_active)
);
...
INSERT INTO currencies (currencies_id, title, code, symbol_left, symbol_right, decimal_point, thousands_point, decimal_places, value, last_updated) VALUES (3,'CHF','CHF','CHF ','','.',',','2','1.0000', now());

# New order state - Paid-Not Processed
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (57,15,(SELECT languages_id FROM languages WHERE code = 'en'),'Paid-Not processed');
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (58,15,(SELECT languages_id FROM languages WHERE code = 'de'),'Bezahlt-Nicht bearbeitet');
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (59,15,(SELECT languages_id FROM languages WHERE code = 'es'),'Pagado-No procesado');
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (60,15,(SELECT languages_id FROM languages WHERE code = 'pt'),'Pago-Não processado');
...
INSERT INTO kk_config (kk_config_key, kk_config_value, date_added) VALUES ('VERSION', '9.4.0.0 MySQL', now());
...
ALTER TABLE kk_booking ADD COLUMN last_modified datetime;

# New API Calls
INSERT INTO kk_api_call (name, description, date_added) VALUES ('deleteReviewsPerCustomer', '', now());
INSERT INTO kk_api_call (name, description, date_added) VALUES ('deleteVendorReviewsPerCustomer', '', now());

# Table for order return status
DROP TABLE IF EXISTS kk_order_return_status;
CREATE TABLE kk_order_return_status (
   returns_status_pk int NOT NULL auto_increment,
   store_id varchar(64),
   returns_status_id int DEFAULT '0' NOT NULL,
   language_id int DEFAULT '1' NOT NULL,
   returns_status_name varchar(32) NOT NULL,
   PRIMARY KEY (returns_status_pk),
   KEY idx_order_return_status (returns_status_name)
);
...
# New API Calls
INSERT INTO kk_api_call (name, description, date_added) VALUES ('getOrderReturnStatuses', '', now());
INSERT INTO kk_api_call (name, description, date_added) VALUES ('deleteOrderReturnStatus', '', now());
INSERT INTO kk_api_call (name, description, date_added) VALUES ('insertOrderReturnStatus', '', now());
INSERT INTO kk_api_call (name, description, date_added) VALUES ('insertOrderReturnStatuses', '', now());
INSERT INTO kk_api_call (name, description, date_added) VALUES ('updateOrderReturnStatus', '', now());
INSERT INTO kk_api_call (name, description, date_added) VALUES ('getAllOrderReturnStatuses', '', now());
...
ALTER TABLE kk_customer_tag ADD used_in_expressions int(1) DEFAULT 1 NOT NULL;
...
# New KKAdminIf API
INSERT INTO kk_api_call (name, description, date_added) VALUES ('deleteCatalogWithOptions', '', now());
