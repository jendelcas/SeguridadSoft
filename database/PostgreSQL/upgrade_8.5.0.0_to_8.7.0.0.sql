...
UPDATE kk_config SET kk_config_value='8.7.0.0 PostgreSQL', date_added=now() WHERE kk_config_key='VERSION';
...
ALTER TABLE currencies ALTER COLUMN decimal_point TYPE VARCHAR(1);
ALTER TABLE currencies ALTER COLUMN thousands_point TYPE VARCHAR(1);
ALTER TABLE currencies ALTER COLUMN decimal_places TYPE VARCHAR(1);
