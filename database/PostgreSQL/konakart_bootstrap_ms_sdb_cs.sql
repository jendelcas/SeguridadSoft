...
UPDATE configuration set configuration_value = 'C:/KonaKart/database/PostgreSQL/konakart_new_store_cs.sql' where configuration_key = 'KK_NEW_STORE_SQL_FILENAME';
