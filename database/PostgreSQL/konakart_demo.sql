...
-- Created: Thu Dec 23 11:25:27 GMT 2021
-- -----------------------------------------------------------
-- 
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, use_function, date_added) VALUES ('Set Order Status', 'MODULE_PAYMENT_COD_ORDER_STATUS_ID', '0', 'Set the status of orders made with this payment module to this value', '6', '0', 'OrderStatuses', 'tep_get_order_status_name', now());
...
INSERT INTO currencies VALUES (DEFAULT,'Euro','EUR','','EUR','.',',','2','1.1000', now());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES                ('Image base path','IMG_BASE_PATH','C:/KonaKart/webapps/konakart/images','The base path where application images are saved','4', '10', now());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES                ('Report definitions base path','REPORTS_DEFN_PATH','C:/KonaKart/webapps/birt-viewer/reports/','The reports definition location','17', '1', now());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Use Solr Search Server','USE_SOLR_SEARCH','false','Use Solr search server to search for products','24', '10', 'choice(''true''=''true'',''false''=''false'')', now());
DELETE FROM configuration WHERE configuration_key = 'SOLR_URL';
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Base URL of Solr Search Server','SOLR_URL','http://localhost:8983/','Base URL of Solr Search Server','24', '30', now());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('KonaKart Installation Home', 'INSTALLATION_HOME','C:/KonaKart/','The home directory of this KonaKart Installation', '1', '26', now());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('PDF Directory', 'PDF_BASE_DIRECTORY', 'C:/KonaKart/pdf/', 'Defines the root directory for the location of the PDF documents that are created', '27', '5', now());
...
ALTER TABLE products_description ALTER COLUMN products_name TYPE VARCHAR(150);
...
ALTER TABLE categories_description ALTER COLUMN categories_name TYPE VARCHAR(150);

-----------------  v5.8.0.0

-- Extend the size of the products_name field
ALTER TABLE orders_products ALTER COLUMN products_name TYPE VARCHAR(150);
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, return_by_api) VALUES ('Suggested Search prepend regex','SOLR_TERMS_PRE_REGEX','.*','Regex prepended to search string used for searching within SOLR term','24', '100', now(), '0');
DELETE FROM configuration WHERE configuration_key = 'SOLR_TERMS_POST_REGEX';
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, return_by_api) VALUES ('Suggested Search append regex','SOLR_TERMS_POST_REGEX','.*','Regex appended to search string used for searching within SOLR term','24', '110', now(), '0');
DELETE FROM configuration WHERE configuration_key = 'SOLR_DELETE_ON_COMMIT';
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, return_by_api) VALUES ('Delete from index on commit','SOLR_DELETE_ON_COMMIT','true','On commit, delete from index products marked for deletion','24', '70', 'choice(''true''=''true'',''false''=''false'')', now(), '0');
...
INSERT INTO products (products_id, products_model, products_price, products_weight, products_status, products_tax_class_id, manufacturers_id, products_quantity, products_ordered, products_date_added, products_date_available) VALUES (DEFAULT, 'WB1100F', 155.99, 1, 1, 1, 21, 100, 0, now(), now());

INSERT INTO products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) VALUES (50, 1, 'Samsung WB1100F Camera', 'Samsung WB1100F Smart Camera - Black (16.2MP Optical Image Stabilisation) 3 inch LCD<br><br>16.2 megapixel sensor delivers superb image quality<br><br>35x zoom lens<br><br>Smart shooting modes ensure brilliant results every time<br><br>Built-in Wi-Fi and NFC let you backup and share your images with ease',E'https://www.samsung.com/uk/discover/camera/',0);
...
INSERT INTO products (products_id, products_model, products_price, products_weight, products_status, products_tax_class_id, manufacturers_id, products_quantity, products_ordered, products_date_added, products_date_available) VALUES (DEFAULT, 'GALTABS4', 699.99, 2, 1, 1, 21, 100, 0, now(), now());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Batch Log file Directory', 'BATCH_LOG_FILE_DIRECTORY', 'C:/KonaKart/batchlogs/', 'The location where KonaKart will write batch log files', '20', '2', now());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Sitemap file Directory', 'SITEMAP_FILE_DIRECTORY', 'C:/KonaKart/batchlogs/', 'The location where KonaKart will write sitemap files', '30', '1', now());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Import files path','IMPORT_FILES_PATH','C:/KonaKart/data/','The import data files location',29,50,now());
...
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (DEFAULT, 4,(SELECT languages_id FROM languages WHERE code = 'de'),'Warte auf Zahlung');
...
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (DEFAULT, 4,(SELECT languages_id FROM languages WHERE code = 'pt'),'À espera de pagamento');
--5
...
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (DEFAULT, 5,(SELECT languages_id FROM languages WHERE code = 'de'),'Zahlung empfangen');
...
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (DEFAULT, 6,(SELECT languages_id FROM languages WHERE code = 'de'),'Zahlung nicht erfolgt');
...
INSERT INTO kk_content (content_id, content_type_id, click_url, search_key, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (16, 1, 'SelectProd.action?prodId={OBJ_ID}','TOP_BANNER_1', 34, 1, 1, 2, now(), now());
...
INSERT INTO kk_content (content_id, content_type_id, click_url, search_key, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (17, 1, 'SelectProd.action?prodId={OBJ_ID}','TOP_BANNER_2', 33, 1, 1, 2, now(), now());
...
INSERT INTO kk_content (content_id, content_type_id, click_url, search_key, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (18, 2, 'ShowSpecials.action','SUB_BANNER_1', 0, 0, 1, 2, now(), now());
...
INSERT INTO kk_content (content_id, content_type_id, click_url, search_key, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (19, 2, 'SelectCat.action?catId={OBJ_ID}','SUB_BANNER_2', 23, 2, 1, 2, now(), now());
...
INSERT INTO kk_content (content_id, content_type_id, click_url, search_key, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (20, 2, 'SelectCat.action?catId={OBJ_ID}','SUB_BANNER_3', 24, 2, 1, 2, now(), now());
...
INSERT INTO kk_content (content_id, content_type_id, click_url, search_key, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (21, 2, 'SelectProd.action?prodId={OBJ_ID}','SUB_BANNER_4', 32, 1, 1, 2, now(), now());
...
INSERT INTO kk_content (content_id, content_type_id, click_url, search_key, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (22, 2, 'SelectProd.action?prodId={OBJ_ID}','SUB_BANNER_5', 35, 1, 1, 2, now(), now());
...
INSERT INTO kk_content (content_id, content_type_id, click_url, search_key, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (23, 5, '','ABOUT_US', 0, 0, 1, 2, now(), now());
...
INSERT INTO kk_content (content_id, content_type_id, click_url, search_key, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (24, 6, '','SHIPPING_HANDLING', 0, 0, 1, 2, now(), now());
...
INSERT INTO kk_content (content_id, content_type_id, click_url, search_key, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (25, 7, '','RETURNS', 0, 0, 1, 2, now(), now());
...
INSERT INTO kk_content (content_id, content_type_id, click_url, search_key, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (26, 8, '','INTERNATIONAL_ORDERS', 0, 0, 1, 2, now(), now());
...
INSERT INTO kk_content (content_id, content_type_id, click_url, search_key, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (27, 9, '','PRIVACY', 0, 0, 1, 2, now(), now());
...
INSERT INTO kk_content (content_id, content_type_id, click_url, search_key, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (28, 10, '','TERMS_CONDITIONS', 0, 0, 1, 2, now(), now());
...
INSERT INTO kk_content (content_id, content_type_id, click_url, search_key, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (29, 11, '','HELP', 0, 0, 1, 2, now(), now());
...
INSERT INTO kk_content (content_id, content_type_id, click_url, search_key, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (30, 12, '','CONTACT', 0, 0, 1, 2, now(), now());
...
-- Logo Image
INSERT INTO kk_content (content_id, content_type_id, click_url, search_key, object_id, obj_type_id, enabled, updated_by, date_updated, date_added) VALUES (31, 13, 'Welcome.action','LOGO', -1, -1, 1, 2, now(), now());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, return_by_api) VALUES ('Add spelling suggestions for catalog','SOLR_ADD_SPELLING_FOR_CATALOG','false','Adds spelling suggestions for each catalog id since the catalog may contain only a subset of products','24', '170', 'choice(''true''=''true'',''false''=''false'')', now(), '1');

DELETE FROM configuration WHERE configuration_key = 'SOLR_CATALOG_USED_FOR_PRICE';
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, return_by_api) VALUES ('Catalogs used for product prices','SOLR_CATALOG_USED_FOR_PRICE','false','Set to true if catalogs are used to determine product prices','24', '180', 'choice(''true''=''true'',''false''=''false'')', now(), '0');

DELETE FROM configuration WHERE configuration_key = 'SOLR_CATALOG_USED_FOR_QTY';
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, return_by_api) VALUES ('Catalogs used for product quantities','SOLR_CATALOG_USED_FOR_QTY','false','Set to true if catalogs are used to determine product quantities','24', '190', 'choice(''true''=''true'',''false''=''false'')', now(), '0');
...
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (DEFAULT, 11,(SELECT languages_id FROM languages WHERE code = 'de'),'Warten auf Bestätigung');
...
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (DEFAULT, 13,(SELECT languages_id FROM languages WHERE code = 'de'),'Genehmigt Abgelehnt');
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, return_by_api, store_id) SELECT 'ERP Integration Enabled?', 'ERP_INT_INTEGRATION_ENABLED', 'false', 'Set to true to enable ERP Integration', '32', '5', 'choice(''true''=''true'',''false''=''false'')', now(), '1', store_id FROM configuration WHERE configuration_key = 'INSTALLATION_HOME';
...
-- New API call
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'updateCustomerWithOptions', '', now());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, return_by_api) VALUES ('Export Order to ERP', 'ERP_EXPORT_ORDER', 'true', 'When set to true KonaKart will export orders to ERP', 32, 70, 'choice(''true''=''true'',''false''=''false'')', now(), '1');
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, return_by_api) VALUES ('Example Parameter 2','USER_DEFINED_EXAMPLE_2','1,3,5','Example of a MultiSelect parameter','31', '15', 'multiselect(0=date.day.short.Sun,1=date.day.short.Mon,2=date.day.short.Tue,3=date.day.short.Wed,4=date.day.short.Thu,5=date.day.short.Fri,6=date.day.short.Sat)', now(), '1');

-- Add some indexes
DROP INDEX IF EXISTS idxorders_status_history_orders_id;
CREATE INDEX idxorders_status_history_orders_id ON orders_status_history (orders_id);
DROP INDEX IF EXISTS idxorders_products_orders_id;
CREATE INDEX idxorders_products_orders_id ON orders_products (orders_id);
DROP INDEX IF EXISTS idxcustomers_basket_customers_id;
CREATE INDEX idxcustomers_basket_customers_id ON customers_basket (customers_id);

-- Custom Attribute Example using the MultiSelect set_function
INSERT INTO kk_cust_attr (kk_cust_attr_id, name, msg_cat_key, attr_type, template, validation, set_function, date_added) VALUES (DEFAULT,'days-of-the-week', null, 0, null, null, 'multiselect(0=date.day.short.Sun,1=date.day.short.Mon,2=date.day.short.Tue,3=date.day.short.Wed,4=date.day.short.Thu,5=date.day.short.Fri,6=date.day.short.Sat)', now());

INSERT INTO kk_cust_attr_tmpl (name, description, date_added, store_id) VALUES ('Example Template', 'Just an example which can be deleted at any time', now(), 'store1');
...
INSERT INTO kk_customer_tag (name, description, validation, tag_type, max_ints, date_added) VALUES ('FACEBOOK_LOGIN_ID', 'The Facebook id for a customer logging in using Facebook', '', 0, 1, now());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, return_by_api) VALUES ('Distributed terms searching','SOLR_DISTRIBUTED_TERMS_SEARCH','false','Add distrib=true parameter to searches for terms','24', '200', 'choice(''true''=''true'',''false''=''false'')', now(), '1');

DELETE FROM configuration WHERE configuration_key = 'SOLR_PATH';
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, return_by_api) VALUES ('SOLR path','SOLR_PATH','solr/konakart','SOLR path (typically this is solr/konakart)','24', '40', now(), '0');
...
-- New API calls
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'cloneCustomer', '', now());
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'deleteCustomerMultiStore', '', now());
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'getStoresForCustomer', '', now());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, return_by_api) VALUES ('Enable Newsletter Double Opt-In','ENABLE_NEWSLETTER_DOUBLE_OPT_IN','false','When true, a customer receives an eMail with a link to click on to confirm newsletter subscription',1, 65, 'choice(''true''=''true'',''false''=''false'')', now(), '1');
...
INSERT INTO kk_panel (code, description, date_added) VALUES ('kk_panel_integrations','ERP Integration Configuration', now());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, return_by_api) VALUES ('Integrated Products','INTEGRATED_PRODUCTS','','Used to store a comma separated list of integrated products',33,10,now(),'1');
...
INSERT INTO kk_customer_tag (name, description, validation, tag_type, max_ints, set_by_api, date_added) VALUES ('PRODUCTS_TIME_VIEWED', 'Recently viewed product id', '((:[0-9]+ [0-9]+)+:|)', 7, 10, 1, now());
DELETE FROM kk_customer_tag WHERE name ='CATEGORIES_TIME_VIEWED';
INSERT INTO kk_customer_tag (name, description, validation, tag_type, max_ints, set_by_api, date_added) VALUES ('CATEGORIES_TIME_VIEWED', 'Recently viewed category id', '((:[0-9]+ [0-9]+)+:|)', 7, 10, 1, now());
DELETE FROM kk_customer_tag WHERE name ='MANUFACTURERS_TIME_VIEWED';
INSERT INTO kk_customer_tag (name, description, validation, tag_type, max_ints, set_by_api, date_added) VALUES ('MANUFACTURERS_TIME_VIEWED', 'Recently viewed manufacturer id', '((:[0-9]+ [0-9]+)+:|)', 7, 10, 1, now());
DELETE FROM kk_customer_tag WHERE name ='PRODUCTS_TIME_IN_CART';
INSERT INTO kk_customer_tag (name, description, validation, tag_type, max_ints, set_by_api, date_added) VALUES ('PRODUCTS_TIME_IN_CART', 'Id of a product in the cart', '((:[0-9]+ [0-9]+)+:|)', 7, 10, 1, now());
DELETE FROM kk_customer_tag WHERE name ='PRODUCTS_TIME_IN_WISHLIST';
INSERT INTO kk_customer_tag (name, description, validation, tag_type, max_ints, set_by_api, date_added) VALUES ('PRODUCTS_TIME_IN_WISHLIST', 'Id of a product in the Wish List', '((:[0-9]+ [0-9]+)+:|)', 7, 10, 1, now());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, return_by_api) VALUES ('URL for AI Service','ARTIFICIAL_INTELLIGENCE_URL','http://to-be-confirmed/','URL for Artificial Intelligence Service',34,10,now(),'0');
DELETE FROM configuration WHERE configuration_key = 'ARTIFICIAL_INTELLIGENCE_CONNECT_TIMEOUT';
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, return_by_api) VALUES ('Connection timeout for AI Service','ARTIFICIAL_INTELLIGENCE_CONNECT_TIMEOUT','20000','Connection timeout for Artificial Intelligence Service in milliseconds',34,20,now(),'0');
DELETE FROM configuration WHERE configuration_key = 'ARTIFICIAL_INTELLIGENCE_READ_TIMEOUT';
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, return_by_api) VALUES ('Read timeout for AI Service','ARTIFICIAL_INTELLIGENCE_READ_TIMEOUT','30000','Read timeout for Artificial Intelligence Service in milliseconds',34,30,now(),'0');
DELETE FROM configuration WHERE configuration_key = 'ARTIFICIAL_INTELLIGENCE_USERNAME';
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, return_by_api) VALUES ('AI Service Username','ARTIFICIAL_INTELLIGENCE_USERNAME','','Artificial Intelligence Service Username',34,40,now(),'0');
DELETE FROM configuration WHERE configuration_key = 'ARTIFICIAL_INTELLIGENCE_PASSWORD';
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, return_by_api, set_function) VALUES ('AI Service Password','ARTIFICIAL_INTELLIGENCE_PASSWORD','','Artificial Intelligence Service Password',34,50,now(),'0','password');
DELETE FROM configuration WHERE configuration_key = 'ARTIFICIAL_INTELLIGENCE_VERSION';
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, return_by_api) VALUES ('AI Data Current Version','ARTIFICIAL_INTELLIGENCE_VERSION','1','Current version of the Artificial Intelligence data',34,60,now(),'1');
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Warn of Duplicate Coupons', 'ADMIN_APP_WARN_OF_DUPLICATE_COUPONS', 'true', 'Issue warning in Admin App of duplicate coupon codes', '21', '32', 'choice(''true''=''true'',''false''=''false'')', now());
...
-- Add index on SKU
DROP INDEX IF EXISTS idxproducts_products_sku;
CREATE INDEX idxproducts_products_sku ON products (products_sku);
DROP INDEX IF EXISTS idxproducts_quantity_products_sku;
CREATE INDEX idxproducts_quantity_products_sku ON products_quantity (products_sku);

-- Used in storefront to set a startup catalog id
DELETE FROM configuration WHERE configuration_key = 'STARTUP_CATALOG_KEY';
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, return_by_api) VALUES ('Startup Catalog Key','STARTUP_CATALOG_KEY','','Default catalog key used at startup',1,80,now(),'1');
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, return_by_api) VALUES ('Future Catalog Date Format','CATALOG_FUTURE_DATE_FORMAT','dd/MM/yyyy HH:mm','Future Catalog Date Format',1,100,now(),'1');
...
INSERT INTO kk_customer_tag (name, description, validation, tag_type, max_ints, date_added) VALUES ('FAVOURITE_CITY', 'Favourite City of the Customer', '', 0, 1, now());
DELETE FROM kk_customer_tag WHERE name ='FAVOURITE_COLOUR';
INSERT INTO kk_customer_tag (name, description, validation, tag_type, max_ints, date_added) VALUES ('FAVOURITE_COLOUR', 'Favourite Colour of the Customer', '', 0, 1, now());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, return_by_api) VALUES ('Status Ids of completed orders','COMPLETED_ORDER_STATUS_IDS','3,5','Comma separated list of Completed Order Status Ids (used in Order Statistics batch jobs)',9,60,now(),'1');
...
INSERT INTO currencies (currencies_id, title, code, symbol_left, symbol_right, decimal_point, thousands_point, decimal_places, value, last_updated) VALUES (DEFAULT,'CHF','CHF','CHF ','','.',',','2','1.0000', now());

-- New order state - Paid-Not Processed
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (DEFAULT, 15,(SELECT languages_id FROM languages WHERE code = 'en'),'Paid-Not processed');
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (DEFAULT, 15,(SELECT languages_id FROM languages WHERE code = 'de'),'Bezahlt-Nicht bearbeitet');
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (DEFAULT, 15,(SELECT languages_id FROM languages WHERE code = 'es'),'Pagado-No procesado');
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (DEFAULT, 15,(SELECT languages_id FROM languages WHERE code = 'pt'),'Pago-Não processado');
...
INSERT INTO kk_config (kk_config_key, kk_config_value, date_added) VALUES ('HISTORY', '9.4.0.0 I', now());
INSERT INTO kk_config (kk_config_key, kk_config_value, date_added) VALUES ('VERSION', '9.4.0.0 PostgreSQL', now());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order,date_added, return_by_api) VALUES ('Output Queue Prefix','ERP_OUTPUT_QUEUE_PREFIX','KonaKart.','Output queue name for ERP integration is this prefix + storeId + .Q',32,110,now(),'1');

-- New configuration variable to allow setting of STARTTLS for emails
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, set_function) VALUES ('SMTP StartTLS','SMTP_STARTTLS','false','Whether or not to enable STARTTLS', '12', '3', now(), 'choice(''true''=''true'',''false''=''false'')');
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order,date_added, return_by_api) VALUES ('System ID','SYSTEM_ID','','Can be used for any custom purpose to identify the system',32,120,now(),'1');
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, set_function) VALUES ('New OT for each tax rate?','MODULE_ORDER_TOTAL_TAX_MULTIPLE_LINES','false','Do you want to have multiple order totals for different tax rates? Tax code must be set on tax class', '6', '3', now(), 'choice(''true''=''true'',''false''=''false'')');
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Run Initial Product Search', 'PROD_PANEL_RUN_INITIAL_SEARCH', 'true', 'Set to true to always run the initial Product Search', 21, 13, 'choice(''true''=''true'',''false''=''false'')', now());
