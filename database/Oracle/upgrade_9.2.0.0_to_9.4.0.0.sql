...
set echo on
INSERT INTO kk_config (kk_config_id, kk_config_key, kk_config_value, date_added) VALUES (kk_config_seq.nextval, 'HISTORY', '9.4.0.0 U', sysdate);
UPDATE kk_config SET kk_config_value='9.4.0.0 Oracle', date_added=sysdate WHERE kk_config_key='VERSION';
...
-- New API Calls
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (kk_api_call_seq.nextval, 'deleteReviewsPerCustomer', '', sysdate);
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (kk_api_call_seq.nextval, 'deleteVendorReviewsPerCustomer', '', sysdate);

-- Table for order return status
BEGIN EXECUTE IMMEDIATE 'DROP TABLE kk_order_return_status'; EXCEPTION WHEN OTHERS THEN NULL; END;
/
CREATE TABLE kk_order_return_status (
  returns_status_pk NUMBER(10,0) NOT NULL,
  store_id VARCHAR2(64),
  returns_status_id NUMBER(10,0) DEFAULT 0 NOT NULL,
  language_id NUMBER(10,0) DEFAULT 1 NOT NULL,
  returns_status_name VARCHAR2(32) NOT NULL,
  PRIMARY KEY(returns_status_pk)
);
CREATE INDEX idx_order_return_status ON kk_order_return_status (returns_status_name);
BEGIN EXECUTE IMMEDIATE 'DROP SEQUENCE kk_order_return_status_SEQ'; EXCEPTION WHEN OTHERS THEN NULL; END;
/
...
-- New API Calls
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (kk_api_call_seq.nextval, 'getOrderReturnStatuses', '', sysdate);
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (kk_api_call_seq.nextval, 'deleteOrderReturnStatus', '', sysdate);
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (kk_api_call_seq.nextval, 'insertOrderReturnStatus', '', sysdate);
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (kk_api_call_seq.nextval, 'insertOrderReturnStatuses', '', sysdate);
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (kk_api_call_seq.nextval, 'updateOrderReturnStatus', '', sysdate);
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (kk_api_call_seq.nextval, 'getAllOrderReturnStatuses', '', sysdate);

-- Add some default order return statuses

INSERT INTO kk_order_return_status (returns_status_pk, returns_status_id, language_id, returns_status_name, store_id) SELECT kk_order_return_status_seq.nextval,0,language_id,'Undefined',store_id from orders_status;
INSERT INTO kk_order_return_status (returns_status_pk, returns_status_id, language_id, returns_status_name, store_id) SELECT kk_order_return_status_seq.nextval,1,language_id,'Requested',store_id from orders_status;
INSERT INTO kk_order_return_status (returns_status_pk, returns_status_id, language_id, returns_status_name, store_id) SELECT kk_order_return_status_seq.nextval,2,language_id,'Approved',store_id from orders_status;
INSERT INTO kk_order_return_status (returns_status_pk, returns_status_id, language_id, returns_status_name, store_id) SELECT kk_order_return_status_seq.nextval,3,language_id,'Rejected',store_id from orders_status;
INSERT INTO kk_order_return_status (returns_status_pk, returns_status_id, language_id, returns_status_name, store_id) SELECT kk_order_return_status_seq.nextval,4,language_id,'Received',store_id from orders_status;
...
INSERT INTO  kk_panel (panel_id, code, description, date_added) VALUES (kk_panel_seq.nextval, 'kk_panel_orderReturnStatuses','Order Return Statuses', sysdate);

-- Give Order Return statuses panel access to all roles that can access the 'kk_panel_orderStatuses' panel
INSERT INTO kk_role_to_panel (role_id, panel_id, can_edit, can_insert, can_delete, date_added, store_id) SELECT role_id, p2.panel_id, 1, 1, 1, sysdate, store_id FROM kk_role_to_panel rtp, kk_panel p, kk_panel p2 where rtp.panel_id=p.panel_id and p.code='kk_panel_orderStatuses' and p2.code='kk_panel_orderReturnStatuses';

-- Configuration variable for defining an output queue prefix
INSERT INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, return_by_api, store_id) SELECT configuration_seq.nextval, 'Output Queue Prefix','ERP_OUTPUT_QUEUE_PREFIX','KonaKart.','Output queue name for ERP integration is this prefix + storeId + .Q',32,110,sysdate,'1', store_id FROM configuration WHERE configuration_key = 'INSTALLATION_HOME';

-- New configuration variable to allow setting of STARTTLS for emails
INSERT INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, return_by_api, store_id) SELECT configuration_seq.nextval, 'SMTP StartTLS','SMTP_STARTTLS','false','Whether or not to enable STARTTLS', '12', '3',sysdate,'1', store_id FROM configuration WHERE configuration_key = 'INSTALLATION_HOME';

-- New configuration variable to be used for custom purposes as a System Id
INSERT INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, return_by_api, store_id) SELECT configuration_seq.nextval, 'System ID','SYSTEM_ID','','Can be used for any custom purpose to identify the system',32,120,sysdate,'1', store_id FROM configuration WHERE configuration_key = 'INSTALLATION_HOME';
...
INSERT INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, return_by_api, store_id) SELECT configuration_seq.nextval, 'Run Initial Product Search', 'PROD_PANEL_RUN_INITIAL_SEARCH', 'true','Set to true to always run the initial Product Search',21, 13,'choice(''true''=''true'',''false''=''false'')', sysdate,'1', store_id FROM configuration WHERE configuration_key = 'INSTALLATION_HOME';

-- For specifying whether or not customer tags are intended to be used in expressions
ALTER TABLE kk_customer_tag ADD used_in_expressions NUMBER(10,0) DEFAULT 1 NOT NULL;
...
-- New KKAdminIf API
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (kk_api_call_seq.nextval, 'deleteCatalogWithOptions', '', sysdate);
exit;
