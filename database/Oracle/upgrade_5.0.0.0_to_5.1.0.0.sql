...
UPDATE configuration set configuration_value = 'C:/KonaKart/database/Oracle/konakart_new_store_cs.sql' where configuration_key = 'KK_NEW_STORE_SQL_FILENAME' and configuration_value = 'C:/KonaKart/database/MySQL/konakart_new_store_cs.sql';
