...
INSERT INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, store_id) SELECT configuration_seq.nextval, 'Exported Orders Directory', 'EXPORT_ORDERS_BASE_DIRECTORY', 'C:/KonaKart/orders', 'Defines the root directory where the Orders are exported to', '7', '7', sysdate, store_id FROM configuration where configuration_key = 'STORE_COUNTRY';
