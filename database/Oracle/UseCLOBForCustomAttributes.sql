...
ALTER TABLE orders_products ADD tempcol CLOB;
UPDATE orders_products SET tempcol = custom_attrs;
ALTER TABLE orders_products DROP COLUMN custom_attrs;
ALTER TABLE orders_products RENAME COLUMN tempcol to custom_attrs;
