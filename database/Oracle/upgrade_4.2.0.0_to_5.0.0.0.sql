...
INSERT INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, store_id) SELECT configuration_seq.nextval, 'PDF Directory', 'PDF_BASE_DIRECTORY', 'C:/KonaKart/pdf', 'Defines the root directory for the location of the PDF documents that are created', '27', '5', sysdate, store_id FROM configuration where configuration_key = 'STORE_COUNTRY';
